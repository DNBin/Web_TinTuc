'object' == typeof navigator &&
  (function (e, t) {
    ...
    var Z = {
      ...
      pe = function (e, t) {
        var i,
          ...
          s = 0,
          r = []
        for (i in n) !v(W, i) && v(n, i) && r.push(i)
    ...
    var _e,
      ...
      Ue = Ne.UNSUPPORTED_Y || Ne.BROKEN_CARET,
      qe = void 0 !== /()??/.exec('')[1]
    ;($e || qe || Ue) &&
      (je = function (e) {
        var t,
    ...
    var Lt,
      ...
      Nt = ne('document', 'documentElement'),
      Mt = z('IE_PROTO'),
      Rt = function () {},
      jt = function (e) {
        ...
        if (
          (g &&
            ...
            Kt !== Object.prototype &&
              o.next &&
              (Ct(o) !== Kt &&
                (Wt ? Wt(o, Kt) : 'function' != typeof o[Gt] && L(o, Gt, Zt)),
              Dt(o, h, !0))),
          s == Qt &&
            m &&
            m.name !== Qt &&
    ...
    var bi = '[object z]' === String(yi),
      ...
      Mi = et('unscopables'),
      Ri = Array.prototype
    null == Ri[Mi] && x.f(Ri, Mi, { configurable: !0, value: Ut(null) })
    var ji = function (e) {
        Ri[Mi][e] = !0
      },
      $i = 'Array Iterator',
    ...
    var Fi = function (e) {
      ...
      ln = zt(
        function (e, t) {
          Wi(this, { type: zi, iterator: Fi(Ki(e).entries), kind: t })
        },
        'Iterator',
        function () {
          var e = Yi(this),
          ...
          if (
            ((t = (function (e) {
              ...
              for (t = 0; t < s.length; t++)
                (i = s[t]), n.push(Ci.test(i) ? 'xn--' + Ni(i) : i)
              return n.join('.')
            })(t)),
            _n.test(t))
          )
            ...
            case cs:
              ...
              if (':' != r || p) {
                if (
                  ...
                  if (zn(e) && '' == h) return Tn
                  if (i && '' == h && (Wn(e) || null !== e.port)) return
              ...
              if (!Cn.test(r)) {
                if (
                  ...
                  if ('' != h) {
                    ...
                    ;(e.port = zn(e) && b === Vn[e.scheme] ? null : b), (h = '')
                  }
                  if (i) return
                  c = ms
                  continue
    ...
    function ha(e) {
      const t = (e) => (ca(e) ? e.split(':').map(Number) : null)
      let i = t(e)
      if (
    ...
    function da(e) {
      ...
      const [n, s] = i,
        r = (100 / n) * s
      if (
        (!!window.CSS && window.CSS.supports(`aspect-ratio: ${n}/${s}`)
    ...
    function pa(e, t, i = 0.05) {
      const n = e / t,
        s = oa(Object.keys(la), n)
      return Math.abs(s - n) <= i ? la[s] : [e, t]
    }
    const ma = {
      getSources() {
      ...
      setup() {
        ...
        ;(e.options.speed = e.config.speed.options),
          xr(this.config.ratio) || da.call(e),
          Object.defineProperty(e.media, 'quality', {
            get() {
              const t = ma.getSources
                .call(e)
    ...
    const wa = {
      ...
      ka = {
        get(e = '', t = {}) {
          if (xr(e) || xr(t)) return ''
          let i = Or(t.i18n, e)
          if (xr(i)) return Object.keys(wa).includes(e) ? wa[e] : ''
    ...
    class Ta {
      constructor(e) {
        $s(this, 'get', (e) => {
          if (!Ta.supported || !this.enabled) return null
          ...
          $s(this, 'set', (e) => {
            if (!Ta.supported || !this.enabled) return
            if (!fr(e)) return
            let t = this.get()
            xr(t) && (t = {}),
              Nr(t, e),
    ...
    const Aa = (e) => Math.trunc((e / 60 / 60) % 60, 10)
    function Ca(e = 0, t = !1, i = !1) {
      if (!gr(e)) return Ca(void 0, t, i)
    ...
    const Pa = {
        ...
        try {
          return (
            ...
            (this.elements.buttons = {
              play: Wr.call(this, this.config.selectors.buttons.play),
      ...
      createButton(e, t) {
        ...
        switch (
          ...
          Object.keys(i).includes('class')
            ? i.class
              ...
              Nr(i, { class: `${i.class} ${this.config.classNames.control}` })
        ...
        return (
          s.toggle
            ? (r.appendChild(
                Pa.createIcon.call(this, s.iconPressed, {
                  class: 'icon--pressed',
                })
              ),
              r.appendChild(
                Pa.createIcon.call(this, s.icon, { class: 'icon--not-pressed' })
              ),
              r.appendChild(
                Pa.createLabel.call(this, s.labelPressed, {
                  class: 'label--pressed',
                })
              ),
              r.appendChild(
                Pa.createLabel.call(this, s.label, {
                  class: 'label--not-pressed',
                })
              ))
            : (r.appendChild(Pa.createIcon.call(this, s.icon)),
              r.appendChild(Pa.createLabel.call(this, s.label))),
          Nr(i, Dr(this.config.selectors.buttons[n], i)),
          Rr(r, i),
          'play' === n
      ...
      createRange(e, t) {
        const i = jr(
          ...
          Nr(
            Dr(this.config.selectors.inputs[e]),
            {
              ...
              autocomplete: 'off',
              role: 'slider',
              'aria-label': ka.get(e, this.config),
              'aria-valuemin': 0,
              'aria-valuemax': 100,
              'aria-valuenow': 0,
            },
        ...
        return (
          ...
          Pa.updateRangeFill.call(this, i),
          sr.setup(i),
          i
        )
      },
        ...
        Zr.call(
          ...
          (i) => {
            ...
            if ((i.preventDefault(), i.stopPropagation(), 'keydown' === i.type))
              return
            const n = zr(e, '[role="menuitemradio"]')
            if (!n && [32, 39].includes(i.which))
              Pa.showMenuPanel.call(this, t, !0)
            else {
              let t
              32 !== i.which &&
          ...
          Zr.call(this, e, 'keyup', (e) => {
            13 === e.which && Pa.focusFirstMenuItem.call(this, null, !0)
          })
      },
      createMenuItem({
        value: e,
            ...
            set(e) {
              e &&
                Array.from(o.parentNode.children)
                  .filter((e) => zr(e, '[role="menuitemradio"]'))
          ...
          this.listeners.bind(
            ...
            (t) => {
              if (!Er(t) || 32 === t.which) {
                ...
                Pa.showMenuPanel.call(this, 'home', Er(t))
              }
            },
            i,
            !1
          ),
          Pa.bindMenuItemShortcuts.call(this, o, i),
          t.appendChild(o)
      },
      formatTime(e = 0, t = !1) {
        if (!gr(e)) return e
        return Ca(e, Aa(this.duration) > 0, t)
      },
      updateTimeDisplay(e = null, t = 0, i = !1) {
        Tr(e) && gr(t) && (e.innerText = Pa.formatTime(t, i))
      },
      updateVolume() {
        this.supported.ui &&
      ...
      setRange(e, t = 0) {
        Tr(e) && ((e.value = t), Pa.updateRangeFill.call(this, e))
      },
      updateProgress(e) {
          ...
          switch (e.type) {
            ...
            case 'seeked':
              ;(t = (function (e, t) {
                ...
                'timeupdate' === e.type &&
                  Pa.setRange.call(this, this.elements.inputs.seek, t)
              break
            case 'playing':
            case 'progress':
      ...
      updateRangeFill(e) {
        ...
        if (Tr(t) && 'range' === t.getAttribute('type')) {
          if (zr(t, this.config.selectors.inputs.seek)) {
            t.setAttribute('aria-valuenow', this.currentTime)
            const e = Pa.formatTime(this.currentTime),
              i = Pa.formatTime(this.duration),
              n = ka.get('seekLabel', this.config)
            t.setAttribute(
              'aria-valuetext',
              n.replace('{currentTime}', e).replace('{duration}', i)
            )
          } else if (zr(t, this.config.selectors.inputs.volume)) {
            const e = 100 * t.value
      ...
      durationUpdate() {
        ...
        !e &&
          ...
          Pa.updateSeekTooltip.call(this)
      },
      ...
      updateSetting(e, t, i) {
        ...
        ).innerHTML = Pa.getLabel.call(this, e, s)
      ...
      getLabel(e, t) {
        switch (e) {
          case 'speed':
            return 1 === t ? ka.get('normal', this.config) : `${t}&times;`
          case 'quality':
            if (gr(t)) {
              const e = ka.get(`qualityLabel.${t}`, this.config)
              return e.length ? e : `${t}p`
            }
            return ya(t)
          case 'captions':
            return Ia.getLabel.call(this)
          default:
            return null
        }
      },
      setQualityMenu(e) {
        ...
        if (
          (Pa.toggleMenuButton.call(this, t, n),
          qr(i),
          Pa.checkMenu.call(this),
          !n)
        )
          return
        const s = (e) => {
          const t = ka.get(`qualityBadge.${e}`, this.config)
          return t.length ? Pa.createBadge.call(this, t) : null
        }
        this.options.quality
          ...
          .forEach((e) => {
            Pa.createMenuItem.call(this, {
              value: e,
              list: i,
              type: t,
              title: Pa.getLabel.call(this, 'quality', e),
              badge: s(e),
            })
          }),
          Pa.updateSetting.call(this, t, i)
      },
      setCaptionsMenu() {
        ...
        const e = 'captions',
          ...
          i = Ia.getTracks.call(this),
          n = Boolean(i.length)
        if (
          (Pa.toggleMenuButton.call(this, e, n),
          qr(t),
          Pa.checkMenu.call(this),
          !n)
        )
        ...
        const s = i.map((e, i) => ({
          ...
          title: Ia.getLabel.call(this, e),
          badge:
            e.language && Pa.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: 'language',
        }))
        s.unshift({
          ...
          title: ka.get('disabled', this.config),
          list: t,
          type: 'language',
        }),
          s.forEach(Pa.createMenuItem.bind(this)),
          Pa.updateSetting.call(this, e, t)
      },
      setSpeedMenu() {
        ...
        Pa.toggleMenuButton.call(this, e, i),
          qr(t),
          Pa.checkMenu.call(this),
          i &&
            (this.options.speed.forEach((i) => {
              Pa.createMenuItem.call(this, {
                ...
                list: t,
                type: e,
                title: Pa.getLabel.call(this, 'speed', i),
              })
            }),
            Pa.updateSetting.call(this, e, t))
      },
      ...
      toggleMenu(e) {
        ...
        i.setAttribute('aria-expanded', s),
          ...
          s && Er(e)
            ? Pa.focusFirstMenuItem.call(this, null, !0)
      ...
      showMenuPanel(e = '', t = !1) {
        ...
        if (Xr.transitions && !Xr.reducedMotion) {
          ...
          const e = Pa.getMenuSize.call(this, i),
            t = (e) => {
              e.target === n &&
        ...
        Hr(s, !0), Hr(i, !1), Pa.focusFirstMenuItem.call(this, i, t)
      },
      setDownloadUrl() {
      ...
      create(e) {
        ...
        return (
            ...
            (a) => {
              ...
              if (
                ...
                if (
                  ...
                  t.appendChild(
                    s.call(this, 'volume', Nr(i, { id: `plyr-volume-${e.id}` }))
                  )
                }
              }
              if (
                ...
                a.appendChild(o),
                  ...
                  this.config.settings.forEach((i) => {
                    const n = jr(
                      'button',
                      Nr(Dr(this.config.selectors.buttons.settings), {
                        type: 'button',
                    ...
                    const s = jr('span', null, ka.get(i, this.config)),
                      a = jr('span', {
                    ...
                    u.appendChild(
                      jr('span', { 'aria-hidden': !0 }, ka.get(i, this.config))
                    ),
                      u.appendChild(
                        jr(
                          'span',
                          { class: this.config.classNames.hidden },
                          ka.get('menuBack', this.config)
                        )
                      ),
                      Zr.call(
                        this,
          ...
          this.isHTML5 && a.call(this, ma.getQualityOptions.call(this)),
          o.call(this),
          c
        )
      },
      inject() {
        if (this.config.loadSprite) {
          const e = Pa.getIconUrl.call(this)
          e.cors && Ea(e.url, 'sprite-plyr')
        }
        ...
        vr(this.config.controls) &&
          ...
          Tr(this.config.controls) || yr(this.config.controls)
            ...
            : ((e = Pa.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
                quality: this.quality,
                captions: Ia.getLabel.call(this),
              })),
              (i = !1))
        let n
        i &&
        ...
        if (
          ...
          Tr(this.elements.controls) || Pa.findElements.call(this),
    ...
    const Ia = {
        setup() {
          ...
          if (
            ...
            const e = this.config.captions.update
              ...
              : 'removetrack'
            Zr.call(this, this.media.textTracks, e, Ia.update.bind(this))
          }
          setTimeout(Ia.update.bind(this), 0)
        },
        update() {
          const e = Ia.getTracks.call(this, !0),
            {
              active: t,
              language: i,
              meta: n,
            ...
            e
              ...
              .forEach((e) => {
                this.debug.log('Track added', e),
                  ...
                  Zr.call(this, e, 'cuechange', () => Ia.updateCues.call(this))
              }),
            ((r && this.language !== i) || !e.includes(s)) &&
              (Ia.setLanguage.call(this, i), Ia.toggle.call(this, t && r)),
            Br(
        ...
        toggle(e, t = !0) {
          ...
          if (s !== i) {
            if (
              ...
              const e = Ia.getTracks.call(this),
                t = Ia.findTrack.call(
                  this,
              ...
              return (
                ...
                void Ia.set.call(this, e.indexOf(t))
              )
            }
            this.elements.buttons.captions &&
              ...
              Pa.updateSetting.call(this, 'captions'),
              ia.call(
                this,
                this.media,
        ...
        set(e, t = !0) {
          const i = Ia.getTracks.call(this)
          if (-1 !== e)
            if (gr(e))
              if (e in i) {
                ...
                Ia.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Ia.updateCues.call(this)
              } else this.debug.warn('Track not found', e)
            else this.debug.warn('Invalid caption argument', e)
          else Ia.toggle.call(this, !1, t)
        },
        setLanguage(e, t = !0) {
          if (!yr(e))
          ...
          const n = Ia.getTracks.call(this),
            s = Ia.findTrack.call(this, [i])
          Ia.set.call(this, n.indexOf(s), t)
        },
        getTracks(e = !1) {
        ...
        getCurrentTrack() {
          return Ia.getTracks.call(this)[this.currentTrack]
        },
        getLabel(e) {
          let t = e
          return (
            !Ar(t) &&
              Xr.textTracks &&
              this.captions.toggled &&
              (t = Ia.getCurrentTrack.call(this)),
            Ar(t)
              ? xr(t.label)
                ? xr(t.language)
                  ? ka.get('enabled', this.config)
                  : e.language.toUpperCase()
                : t.label
              : ka.get('disabled', this.config)
          )
        },
        updateCues(e) {
          if (!this.supported.ui) return
          ...
          let t = e
          if (!t) {
            const e = Ia.getCurrentTrack.call(this)
      ...
      Oa = 'picture-in-picture',
      Na = 'inline',
      Ma = { html5: 'html5', youtube: 'youtube', vimeo: 'vimeo' },
      Ra = 'audio',
      ja = 'video'
    const $a = () => {}
    class Ua {
    ...
    class qa {
        ...
        $s(this, 'onChange', () => {
          ...
          $s(this, 'exit', () => {
            if (this.enabled)
              ...
              else if (!qa.native || this.forceFallback) this.toggleFallback(!1)
              else if (this.prefix) {
                if (!xr(this.prefix)) {
          ...
          (this.player = e),
          (this.prefix = qa.prefix),
          (this.property = qa.property),
      ...
      get usingNative() {
        return qa.native && !this.forceFallback
      }
      static get prefix() {
      ...
      get enabled() {
        return (
          (qa.native || this.player.config.fullscreen.fallback) &&
      ...
      get active() {
        ...
        if (!qa.native || this.forceFallback)
          return Vr(
            this.target,
            this.player.config.classNames.fullscreen.fallback
          )
      ...
      build() {
        if ((this.listeners.media(), !this.supported.ui))
          return (
            ...
            void Da.toggleNativeControls.call(this, !0)
          )
        Tr(this.elements.controls) ||
          (Pa.inject.call(this), this.listeners.controls()),
          Da.toggleNativeControls.call(this),
          this.isHTML5 && Ia.setup.call(this),
          (this.volume = null),
          (this.muted = null),
          (this.loop = null),
          (this.quality = null),
          (this.speed = null),
          Pa.updateVolume.call(this),
          Pa.timeUpdate.call(this),
          Da.checkPlaying.call(this),
          Br(
            this.elements.container,
          ...
          Da.setTitle.call(this),
          this.poster &&
            Da.setPoster.call(this, this.poster, !1).catch(() => {}),
          this.config.duration && Pa.durationUpdate.call(this)
      },
      setTitle() {
        let e = ka.get('play', this.config)
        if (
          ...
          const t = xr(this.config.title) ? 'video' : this.config.title,
            i = ka.get('frameTitle', this.config)
        ...
        return t && this.poster
          ...
          : (this.media.setAttribute('data-poster', e),
            ...
            sa
              ...
              .then(() => Fa(e))
              .catch((t) => {
                throw (e === this.poster && Da.togglePoster.call(this, !1), t)
              })
              .then(() => {
                if (e !== this.poster)
                  throw new Error(
        ...
        Br(
          ...
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            Object.assign(e, { pressed: this.playing }),
              e.setAttribute(
                'aria-label',
                ka.get(this.playing ? 'pause' : 'play', this.config)
              )
          }),
          (Sr(e) && 'timeupdate' === e.type) || Da.toggleControls.call(this)
      },
      checkLoading(e) {
    ...
    class Ha {
        ...
        $s(this, 'firstTouch', () => {
              ...
              'focusout' !== e.type &&
                (this.focusTimer = setTimeout(() => {
                  ...
                  i.container.contains(e) &&
                    Br(document.activeElement, t.config.classNames.tabFocus, !0)
                }, 10)))
          }),
          $s(this, 'global', (e = !0) => {
            const { player: t } = this
              ...
              Zr.call(
                ...
                (t) => {
                  ...
                  ;['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                    (Da.toggleControls.call(e, !0), (r = e.touch ? 3e3 : 2e3)),
                    clearTimeout(n.controls),
                    (n.controls = setTimeout(
                      () => Da.toggleControls.call(e, !1),
                      r
                    ))
                }
              )
            const s = (t) => {
                if (!t) return da.call(e)
                const n = i.container.getBoundingClientRect(),
                  { width: s, height: r } = n
                return da.call(e, `${s}:${r}`)
              },
              r = () => {
            ...
            Zr.call(e, i.container, 'enterfullscreen exitfullscreen', (t) => {
              ...
              ;((t, i, n) => {
                ...
                const s = e.elements.wrapper.firstChild,
                  [, r] = t,
                  [a, o] = ha.call(e)
                ;(s.style.maxWidth = n ? (r / o) * a + 'px' : null),
                  (s.style.margin = n ? '0 auto' : null)
              })(c, 0, o),
                o && setTimeout(() => Ir(i.container), 100),
                a ||
                  (o
                    ? Zr.call(e, window, 'resize', r)
                    : ea.call(e, window, 'resize', r))
            })
          }),
          $s(this, 'media', () => {
            const { player: e } = this,
            ...
            if (
              (Zr.call(e, e.media, 'timeupdate seeking seeked', (t) =>
                Pa.timeUpdate.call(e, t)
              ),
              Zr.call(
                e,
                e.media,
                'durationchange loadeddata loadedmetadata',
                (t) => Pa.durationUpdate.call(e, t)
              ),
              ...
              Zr.call(e, e.media, 'progress playing seeking seeked', (t) =>
                Pa.updateProgress.call(e, t)
              ),
              Zr.call(e, e.media, 'volumechange', (t) =>
                Pa.updateVolume.call(e, t)
              ),
              Zr.call(
                e,
                e.media,
                'playing play pause ended emptied timeupdate',
                (t) => Da.checkPlaying.call(e, t)
              ),
              Zr.call(e, e.media, 'waiting canplay seeked playing', (t) =>
                Da.checkLoading.call(e, t)
              ),
              ...
              Zr.call(e, t.container, 'click', (n) => {
                ;([t.container, i].includes(n.target) ||
                  i.contains(n.target)) &&
            ...
            e.supported.ui &&
              ...
              Zr.call(e, e.media, 'ratechange', () => {
                Pa.updateSetting.call(e, 'speed'),
                  e.storage.set({ speed: e.speed })
              }),
              Zr.call(e, e.media, 'qualitychange', (t) => {
                Pa.updateSetting.call(e, 'quality', null, t.detail.quality)
              }),
              Zr.call(e, e.media, 'ready qualitychange', () => {
                Pa.setDownloadUrl.call(e)
              })
          ...
          $s(this, 'controls', () => {
            ...
            if (
                  ...
                  ;[13, 32].includes(i) &&
                    (13 !== i
                      ? (t.preventDefault(),
                        t.stopPropagation(),
                        Pa.toggleMenu.call(e, t))
                      : Pa.focusFirstMenuItem.call(e, null, !0))
                },
                null,
                !1
              ),
              this.bind(t.settings.menu, 'keydown', (t) => {
                27 === t.which && Pa.toggleMenu.call(e, t)
              }),
              ...
              const t = Wr.call(e, 'input[type="range"]')
            ...
            this.bind(
              ...
              _r.isWebkit &&
                Array.from(Wr.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, 'input', (t) =>
                    Pa.updateRangeFill.call(e, t.target)
                  )
                }),
        ...
        if (s) {
          ...
          if (Tr(s)) {
            const { editable: n } = t.config.selectors,
              { seek: r } = i.inputs
            if (s !== r && zr(s, n)) return
            if (32 === e.which && zr(s, 'button, [role^="menuitem"]')) return
          }
          switch (
            ([
      ...
      toggleMenu(e) {
        Pa.toggleMenu.call(this.player, e)
      }
    }
    var Ba = t(function (e, t) {
      e.exports = (function () {
        var e = function () {},
          t = {},
          i = {},
    ...
    const Wa = {
      ...
      ready() {
        ...
        var l
        const c = jr('iframe'),
          u = fa(e.config.urls.vimeo.iframe, o, r)
        if (
        ...
        t.customControls ||
          Sa(fa(e.config.urls.vimeo.api, u)).then((t) => {
            !xr(t) &&
              t.thumbnail_url &&
              Da.setPoster.call(e, t.thumbnail_url).catch(() => {})
          }),
        ...
        Object.defineProperty(e.media, 'loop', {
          ...
          Promise.all([e.embed.getVideoWidth(), e.embed.getVideoHeight()]).then(
            (t) => {
              const [i, n] = t
              ;(e.embed.ratio = pa(i, n)), da.call(this)
            }
          ),
          ...
          e.embed.getVideoTitle().then((t) => {
            ;(e.config.title = t), Da.setTitle.call(this)
          }),
          ...
          e.embed.getTextTracks().then((t) => {
            ;(e.media.textTracks = t), Ia.setup.call(e)
          }),
          ...
          t.customControls && setTimeout(() => Da.build.call(e), 0)
      },
    }
    function Ka(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        ...
        setup() {
          if (
            ...
            ;(window.onYouTubeIframeAPIReady = () => {
              vr(e) && e(), Ga.ready.call(this)
            }),
              Va(this.config.urls.youtube.sdk).catch((e) => {
                this.debug.warn('YouTube API failed to load', e)
              })
          }
        },
        getTitle(e) {
          Sa(fa(this.config.urls.youtube.api, e))
            .then((e) => {
              if (fr(e)) {
                const { title: t, height: i, width: n } = e
                ;(this.config.title = t),
                  Da.setTitle.call(this),
                  (this.embed.ratio = pa(n, i))
              }
              da.call(this)
            })
            .catch(() => {
        ...
        ready() {
          ...
          if (((e.media = Fr(a, e.media)), t.customControls)) {
            ...
            Fa(t('maxres'), 121)
              .catch(() => Fa(t('sd'), 121))
              .catch(() => Fa(t('hq')))
              .then((t) => Da.setPoster.call(e, t.src))
              .then((t) => {
                t.includes('maxres') ||
          ...
          e.embed = new window.YT.Player(e.media, {
            ...
            events: {
              ...
              onReady(i) {
                ...
                const n = i.target
                Ga.getTitle.call(e, s),
                  (e.media.play = () => {
                    Ka.call(e, !0), n.playVideo()
                  }),
                  (e.media.pause = () => {
                    Ka.call(e, !1), n.pauseVideo()
                  }),
                  (e.media.stop = () => {
                    n.stopVideo()
                  }),
                ...
                ;(e.options.speed = o.filter((t) =>
                  ...
                  t.customControls && setTimeout(() => Da.build.call(e), 50)
              },
              onStateChange(i) {
                const n = i.target
                ...
                switch (
                  ...
                  case 1:
                    ...
                    break
                  case 2:
                    e.muted || e.embed.unMute(), Ka.call(e, !1)
                    break
                  case 3:
                    ia.call(e, e.media, 'waiting')
                }
          ...
          this.media
            ? (Br(
              ...
              this.isVideo &&
                ...
                Mr(this.media, this.elements.wrapper),
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? Ga.setup.call(this)
                : this.isVimeo && Wa.setup.call(this))
    ...
    class Qa {
        ...
        $s(this, 'load', () => {
          this.enabled &&
            (fr(window.google) && fr(window.google.ima)
              ? this.ready()
              : Va(this.player.config.urls.googleIMA.sdk)
                  .then(() => {
                    this.ready()
                  })
                  .catch(() => {
          ...
          $s(this, 'pollCountdown', (e = !1) => {
            ...
            this.countdownTimer = setInterval(() => {
              const e = Ca(Math.max(this.manager.getRemainingTime(), 0)),
                t = `${ka.get('advertisement', this.player.config)} - ${e}`
      ...
      get tagUrl() {
        ...
        return `https://go.aniview.com/api/adserver6/vast/?${La({
    ...
    class eo {
        ...
        $s(this, 'load', () => {
          ...
          $s(
            ...
            (e) =>
              new Promise((t) => {
                Sa(e).then((i) => {
                  const n = { frames: Ja(i), height: null, urlPrefix: '' }
            ...
            if (
              ...
              if ('touchmove' === e.type)
                ...
                ;(this.seekTime = this.player.media.duration * (i / 100)),
                  ...
                  (this.elements.thumb.time.innerText = Ca(this.seekTime))
              }
          ...
          $s(this, 'setScrubbingContainerSize', () => {
            const { width: e, height: t } = Za(this.thumbAspectRatio, {
      ...
      get thumbContainerHeight() {
        if (this.mouseDown) {
          const { height: e } = Za(this.thumbAspectRatio, {
            width: this.player.media.clientWidth,
            height: this.player.media.clientHeight,
          })
          return e
            ...
            this.destroy.call(
              ...
              () => {
                ...
                Object.assign(this, {
                  ...
                  Da.addStyleHook.call(this),
                  this.isHTML5 && to.insertElements.call(this, 'source', t),
                  (this.config.title = e.title),
                  Xa.setup.call(this),
                  this.isHTML5 &&
                    Object.keys(e).includes('tracks') &&
                    to.insertElements.call(this, 'track', e.tracks),
                  ...
                  xr(e.previewThumbnails) ||
                    ...
                    this.config.previewThumbnails.enabled &&
                      (this.previewThumbnails = new eo(this))),
    ...
    class io {
      constructor(e, t) {
        if (
          ...
          $s(this, 'destroy', (e, t = !1) => {
            ...
            this.stop(),
              ...
              this.isHTML5
                ? (Da.toggleNativeControls.call(this, !0), i())
                : this.isYouTube
          ...
          (this.debug = new Ua(this.config.debug)),
        ...
        switch (n) {
          case 'div':
            ...
            if (xr(this.provider) || !Object.values(Ma).includes(this.provider))
        ...
        ;(this.supported = Xr.check(
          ...
          this.supported.api
            ? ((this.eventListeners = []),
              (this.listeners = new Ha(this)),
              (this.storage = new Ta(this)),
              (this.media.plyr = this),
              Tr(this.elements.container) ||
                ((this.elements.container = jr('div', { tabindex: 0 })),
                Mr(this.media, this.elements.container)),
              Da.migrateStyles.call(this),
              Da.addStyleHook.call(this),
              Xa.setup.call(this),
              this.config.debug &&
                Zr.call(
              ...
              (this.fullscreen = new qa(this)),
              (this.isHTML5 || (this.isEmbed && !this.supported.ui)) &&
                Da.build.call(this),
              this.listeners.container(),
              this.listeners.global(),
              this.config.ads.enabled && (this.ads = new Qa(this)),
              this.isHTML5 &&
                this.config.autoplay &&
      ...
      get isHTML5() {
        return this.provider === Ma.html5
      }
      get isEmbed() {
        return this.isYouTube || this.isVimeo
      }
      get isYouTube() {
        return this.provider === Ma.youtube
      }
      get isVimeo() {
        return this.provider === Ma.vimeo
      }
      get isVideo() {
        return this.type === ja
      }
      ...
      set download(e) {
        Pr(e) && ((this.config.urls.download = e), Pa.setDownloadUrl.call(this))
      }
      set poster(e) {
        this.isVideo
          ? Da.setPoster.call(this, e, !1).catch(() => {})
      ...
      get ratio() {
        ...
        const e = ua(ha.call(this))
        return wr(e) ? e.join(':') : e
      }
      set ratio(e) {
        this.isVideo
          ? yr(e) && ca(e)
            ? ((this.config.ratio = ua(e)), da.call(this))
      ...
      toggleCaptions(e) {
        Ia.toggle.call(this, e, !1)
      }
      set currentTrack(e) {
        Ia.set.call(this, e, !1)
      }
      get currentTrack() {
      ...
      set language(e) {
        Ia.setLanguage.call(this, e, !1)
      }
      get language() {
        return (Ia.getCurrentTrack.call(this) || {}).language
      }
      set pip(e) {
        if (!Xr.pip) return
        const t = br(e) ? e : !this.pip
        vr(this.media.webkitSetPresentationMode) &&
          this.media.webkitSetPresentationMode(t ? Oa : Na),
      ...
      get pip() {
        return Xr.pip
          ? xr(this.media.webkitPresentationMode)
            ...
            : this.media.webkitPresentationMode === Oa
          : null
      }
      ...
      static setup(e, t = {}) {
        ...
        return (
          yr(e)
            ...
            ? (i = Array.from(e))
            : wr(e) && (i = e.filter(Tr)),
          xr(i) ? null : i.map((e) => new io(e, t))
        )
      }
    }
    var no
    return (io.defaults = ((no = _a), JSON.parse(JSON.stringify(no)))), io
  })
