    ...
    !j &&
        ...
        keyboard: {
          ...
          left: function (b) {
            if ((b.preventDefault(), this.is_open(b.currentTarget)))
              ...
              c &&
                c.id !== a.jstree.root &&
                this.get_node(c, !0).children('.jstree-anchor').trigger('focus')
            }
          },
          up: function (a) {
            a.preventDefault()
            var b = this.get_prev_dom(a.currentTarget)
            b && b.length && b.children('.jstree-anchor').trigger('focus')
          },
          right: function (b) {
            if ((b.preventDefault(), this.is_closed(b.currentTarget)))
              this.open_node(b.currentTarget, function (a) {
                this.get_node(a, !0).children('.jstree-anchor').trigger('focus')
              })
      ...
      (a.jstree.core.prototype = {
            ...
            .on(
              ...
              a.proxy(function () {
                if (
                  ...
                  a && a.find('> .jstree-anchor').trigger('focus')
                }
              }, this)
            )
            .on(
        ...
        load_node: function (b, c) {
          var d, e, f, g, h
          if (a.vakata.is_array(b)) return this._load_nodes(b.slice(), c), !0
        ...
        _load_node: function (b, c) {
          ...
          return d
            ? a.vakata.is_function(d)
              ...
              ? d.url
                ? ((d = a.extend(!0, {}, d)),
                  a.vakata.is_function(d.url) && (d.url = d.url.call(this, b)),
        ...
        redraw_node: function (b, c, d, e) {
          ...
          for (
            f.a_attr.id || (f.a_attr.id = f.id + '_anchor'),
              b.childNodes[1].setAttribute('aria-selected', !!f.state.selected),
              b.childNodes[1].setAttribute('aria-level', f.parents.length),
                      ...
                      ? h
                          ...
                          .slideUp(d, function () {
                            ;(this.style.display = ''),
                              ...
                              g.element && g.trigger('after_close', { node: c })
                          })
                      : ((h[0].className = h[0].className.replace(
                          'jstree-open',
                          'jstree-closed'
                        )),
                        h.children('.jstree-anchor').attr('aria-expanded', !1),
                        h.children('.jstree-children').remove(),
        ...
        set_state: function (c, d) {
          if (c) {
            if (
              ...
              if (c.core.open)
                return (
                  a.vakata.is_array(c.core.open) && c.core.open.length
        ...
        get_json: function (b, c, d) {
          ...
          var e = {
              ...
              data:
                c && c.no_data
                  ? !1
                  : a.extend(!0, a.vakata.is_array(b.data) ? [] : {}, b.data),
            },
            f,
            g
          if (
          ...
          return (b = this.get_node(b))
            ? this.check('edit', b, this.get_parent(b))
              ? ((n = b),
                ...
                (g = b.children('.jstree-anchor').trigger('focus')),
                (h = a('<span></span>')),
                (j = c),
                (k = a('<div></div>', {
                  css: {
                    ...
                    '' === f && (f = j),
                      ...
                      setTimeout(
                        a.proxy(function () {
                          ...
                          a.length &&
                            ((this._data.core.focused = n.id),
                            a.children('.jstree-anchor').trigger('focus'))
                        }, this),
                        0
                      ),
                    ...
                    if (-1 !== n.indexOf('down'))
                      if (e.state[o ? 'selected' : 'checked']) {
                        ...
                        this._data[o ? 'core' : 'checkbox'].selected =
                          this._data[o ? 'core' : 'checkbox'].selected.concat(f)
                      } else
                        for (i = 0, j = f.length; j > i; i++)
                      ...
                      for (
                        ...
                        while (e && e.id !== a.jstree.root) {
                          for (h = 0, i = 0, j = e.children.length; j > i; i++)
                            h +=
                              d[e.children[i]].state[o ? 'selected' : 'checked']
                          if (h !== j) break
              ...
              c.element
                ...
                .on('keydown', function (a) {
                  ...
                  var b = c.element
                    ...
                    .parent()
                  b.parent().not('.vakata-context-disabled') &&
                    b.trigger('click')
                }),
              a(i)
                ...
                if (
                  ...
                  c &&
                    ...
                    (this.settings.dnd.is_draggable === !0 ||
                      (a.vakata.is_function(this.settings.dnd.is_draggable) &&
              ...
              .on(
                ...
                a.proxy(function (a, b) {
                  this._data.search.som &&
                    b.res.length &&
                    (this.show_node(this._data.search.hdn, !0), this.redraw(!0))
                }, this)
              )
        }),
              ...
              return a.vakata.is_function(j)
                ? j.call(
                    ...
                    a.proxy(function (b) {
                      b && b.d && (b = b.d),
                        this._load_nodes(
                          a.vakata.is_array(b) ? a.vakata.array_unique(b) : [],
                          function () {
        ...
        ;(this.bind = function () {
          ...
          (this.restore_state = function () {
            ...
            return b && b.ttl && b.sec && +new Date() - b.sec > b.ttl
              ...
              : (b && b.state && (b = b.state),
                b &&
                  a.vakata.is_function(this.settings.state.filter) &&
