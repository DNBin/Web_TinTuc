...
!(function (t, e) {
  ...
  function j(t, b, o) {
      ...
      var e = function (t) {
          var e,
            ...
            n = (function (r, t, n) {
              ...
              return (
                (r.pageOffset = t), (r.points = [s, a]), (r.cursor = i || o), r
              )
    ...
    function B(t, e) {
      e.handle && (ht(e.handle, b.cssClasses.active), (m -= 1)),
        ...
        0 === m &&
          ...
          Q(),
          t.cursor &&
            ((E.style.cursor = ''), E.removeEventListener('selectstart', ut))),
    ...
    function n(t) {
      ...
      !1 !== r &&
        ...
        W('change', r, !0),
        W('set', r, !0),
        b.events.snap && q(t, { handleNumbers: [r] }))
    }
    function X(t) {
      var e = F(t.calcPoint),
        r = y.getStep(e),
    ...
    dt((e = d), b.cssClasses.target),
      ...
      (c = b.events).fixed ||
        u.forEach(function (t, e) {
          H(p.start, t.children[0], q, { handleNumbers: [e] })
        }),
      c.tap && H(p.start, l, n, {}),
  ...
  var H = { __spectrum: a, cssClasses: u, create: z }
  ;(st.create = z),
    (st.cssClasses = u),
    (st.default = H),
