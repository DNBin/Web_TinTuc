...
'object' == typeof navigator &&
  (function (e, t) {
    ...
    const Ue = {
      ...
      createButton(e, t) {
        ...
        return (
          n.toggle
            ? (a.appendChild(
                Ue.createIcon.call(this, n.iconPressed, {
                  class: 'icon--pressed',
                })
              ),
              a.appendChild(
                Ue.createIcon.call(this, n.icon, { class: 'icon--not-pressed' })
              ),
              a.appendChild(
                Ue.createLabel.call(this, n.labelPressed, {
                  class: 'label--pressed',
                })
              ),
              a.appendChild(
                Ue.createLabel.call(this, n.label, {
      ...
      createRange(e, t) {
        ...
        return (
          ...
          Ue.updateRangeFill.call(this, i),
          T.setup(i),
          i
        )
      },
        ...
        fe.call(
          ...
          (i) => {
            ...
            if (!s && [32, 39].includes(i.which))
              Ue.showMenuPanel.call(this, t, !0)
            else {
              let t
              32 !== i.which &&
              ...
              ;(s = this.currentTime),
                ...
                (t =
                  0 === s || 0 === n || Number.isNaN(s) || Number.isNaN(n)
                    ...
                    : ((s / n) * 100).toFixed(2)),
                'timeupdate' === e.type &&
                  Ue.setRange.call(this, this.elements.inputs.seek, t)
              break
            case 'playing':
            case 'progress':
      ...
      updateSetting(e, t, i) {
        ...
        ).innerHTML = Ue.getLabel.call(this, e, n)
      ...
      setQualityMenu(e) {
        ...
        if (
          (Ue.toggleMenuButton.call(this, t, s),
          ie(i),
      ...
      setCaptionsMenu() {
        ...
        const e = 'captions',
          ...
          s = Boolean(i.length)
        if (
          (Ue.toggleMenuButton.call(this, e, s),
          ie(t),
          Ue.checkMenu.call(this),
          !s)
        )
        ...
        const n = i.map((e, i) => ({
          ...
          badge:
            e.language && Ue.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: 'language',
        }))
        n.unshift({
          ...
          n.forEach(Ue.createMenuItem.bind(this)),
      ...
      toggleMenu(e) {
        ...
        i.setAttribute('aria-expanded', n),
          ...
          n && R(e)
            ? Ue.focusFirstMenuItem.call(this, null, !0)
              ...
              if (
                ...
                l.appendChild(o),
                  ...
                  this.config.settings.forEach((i) => {
                    ...
                    h.appendChild(
                      Z('span', { 'aria-hidden': !0 }, De.get(i, this.config))
                    ),
                      h.appendChild(
                        Z(
                          'span',
      ...
      inject() {
        ...
        if (
          ...
          H(this.elements.controls) || Ue.findElements.call(this),
            ...
            e
              ...
              .forEach((e) => {
                this.debug.log('Track added', e),
                  ...
                  fe.call(this, e, 'cuechange', () => Ke.updateCues.call(this))
              }),
            ((a && this.language !== i) || !e.includes(n)) &&
              (Ke.setLanguage.call(this, i), Ke.toggle.call(this, t && a)),
            le(
            ...
            if ($(e))
              if (e in i) {
                ...
                Ke.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Ke.updateCues.call(this)
    ...
    class it {
      ...
      get enabled() {
        return (
          (it.native || this.player.config.fullscreen.fallback) &&
      ...
      get active() {
        ...
        if (!it.native || this.forceFallback)
          return oe(
            this.target,
            this.player.config.classNames.fullscreen.fallback
          )
      ...
      build() {
        if ((this.listeners.media(), !this.supported.ui))
          return (
            ...
            void nt.toggleNativeControls.call(this, !0)
          )
        H(this.elements.controls) ||
          (Ue.inject.call(this), this.listeners.controls()),
          ...
          this.poster &&
            nt.setPoster.call(this, this.poster, !1).catch(() => {}),
              ...
              fe.call(
                ...
                (t) => {
                  ...
                  ;['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                    (nt.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
                    clearTimeout(s.controls),
                    (s.controls = setTimeout(
                      () => nt.toggleControls.call(e, !1),
                      a
                    ))
                }
              )
            ...
            fe.call(e, i.container, 'enterfullscreen exitfullscreen', (t) => {
              ...
              ;((t, i, s) => {
                ...
                const n = e.elements.wrapper.firstChild,
                  [, a] = t,
                  [l, o] = Ne.call(e)
                ;(n.style.maxWidth = s ? (a / o) * l + 'px' : null),
                  (n.style.margin = s ? '0 auto' : null)
              })(c, 0, o),
                o && setTimeout(() => K(i.container), 100),
                l ||
                  (o
                    ? fe.call(e, window, 'resize', a)
                    : be.call(e, window, 'resize', a))
            })
          }),
          e(this, 'media', () => {
            const { player: e } = this,
            ...
            if (
              (fe.call(e, e.media, 'timeupdate seeking seeked', (t) =>
                Ue.timeUpdate.call(e, t)
              ),
              fe.call(
                e,
                e.media,
                'durationchange loadeddata loadedmetadata',
                (t) => Ue.durationUpdate.call(e, t)
              ),
              ...
              fe.call(e, e.media, 'progress playing seeking seeked', (t) =>
                Ue.updateProgress.call(e, t)
              ),
              fe.call(e, e.media, 'volumechange', (t) =>
                Ue.updateVolume.call(e, t)
              ),
              fe.call(
                e,
                e.media,
                'playing play pause ended emptied timeupdate',
                (t) => nt.checkPlaying.call(e, t)
              ),
              fe.call(e, e.media, 'waiting canplay seeked playing', (t) =>
                nt.checkLoading.call(e, t)
              ),
                  ...
                  ;[13, 32].includes(i) &&
                    (13 !== i
                      ? (t.preventDefault(),
                        t.stopPropagation(),
                        Ue.toggleMenu.call(e, t))
                      : Ue.focusFirstMenuItem.call(e, null, !0))
                },
                null,
                !1
              ),
            ...
            this.bind(
              ...
              Y.isWebkit &&
                Array.from(ce.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, 'input', (t) =>
                    Ue.updateRangeFill.call(e, t.target)
                  )
                }),
      ...
      ready() {
        ...
        t.customControls ||
          Fe(Le(e.config.urls.vimeo.api, h)).then((t) => {
            !W(t) &&
              t.thumbnail_url &&
              nt.setPoster.call(e, t.thumbnail_url).catch(() => {})
          }),
    ...
    class bt {
      constructor(t) {
        e(this, 'load', () => {
          ...
          e(this, 'setScrubbingContainerSize', () => {
            const { width: e, height: t } = ft(this.thumbAspectRatio, {
      ...
      get thumbContainerHeight() {
        if (this.mouseDown) {
          const { height: e } = ft(this.thumbAspectRatio, {
            width: this.player.media.clientWidth,
            height: this.player.media.clientHeight,
          })
          return e
              ...
              () => {
                ...
                Object.assign(this, {
                  ...
                  this.isHTML5 &&
                    ...
                    yt.insertElements.call(this, 'track', e.tracks),
    ...
    class vt {
      constructor(t, i) {
        ...
        switch (n) {
          case 'div':
            ...
            if (W(this.provider) || !Object.values(Je).includes(this.provider))
      ...
      set poster(e) {
        this.isVideo
          ? nt.setPoster.call(this, e, !1).catch(() => {})
      ...
      set ratio(e) {
        this.isVideo
          ? _(e) && Ee(e)
            ? ((this.config.ratio = Pe(e)), Me.call(this))
      ...
      set pip(e) {
        ...
        q(this.media.webkitSetPresentationMode) &&
          this.media.webkitSetPresentationMode(t ? Qe : Xe),
      ...
      get pip() {
        return me.pip
          ? W(this.media.webkitPresentationMode)
            ...
            : this.media.webkitPresentationMode === Qe
          : null
      }
