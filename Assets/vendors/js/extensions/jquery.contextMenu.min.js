!(function (e) {
  ...
  var c = null,
    ...
    s = { timer: null, pageX: null, pageY: null },
    b = {
      ...
      contextmenu: function (e) {
        var t = m(this)
        if (
          !1 !== e.data.events.preShow(t, e) &&
          ('right' === e.data.trigger &&
            (e.preventDefault(), e.stopImmediatePropagation()),
          !(
            ('right' !== e.data.trigger &&
              'demand' !== e.data.trigger &&
              e.originalEvent) ||
            !(
              void 0 === e.mouseButton ||
              !e.data ||
              ('left' === e.data.trigger && 0 === e.mouseButton) ||
              ('right' === e.data.trigger && 2 === e.mouseButton)
            ) ||
            t.hasClass('context-menu-active') ||
            t.hasClass('context-menu-disabled')
          ))
        ) {
          if (((c = t), e.data.build)) {
      ...
      mousedown: function (e) {
        ...
        c &&
          c.length &&
          !c.is(t) &&
          c.data('contextMenu').$menu.trigger('contextmenu:hide'),
          2 === e.button && (c = t.data('contextMenuActive', !0))
      },
      mouseup: function (e) {
        var t = m(this)
        t.data('contextMenuActive') &&
          c &&
          c.length &&
          c.is(t) &&
          !t.hasClass('context-menu-disabled') &&
      ...
      mouseleave: function (e) {
        ...
        if (
          !t.is('.context-menu-list') &&
          !t.closest('.context-menu-list').length
        ) {
          try {
                ...
                if (c.reposition && t)
                  if (document.elementFromPoint) {
                    ...
                    i.top <= a.pageY &&
                      ((i.left += e.scrollLeft()),
                      i.left <= a.pageX &&
                        ((i.bottom = i.top + c.$trigger.outerHeight()),
                        i.bottom >= a.pageY &&
                          ((i.right = i.left + c.$trigger.outerWidth()),
                          i.right >= a.pageX))))
                  )
                    return void c.position.call(c.$trigger, c, r, u)
                s &&
                  t &&
                  c.$trigger.one('contextmenu:hidden', function () {
      ...
      key: function (e) {
        ...
        var n = 0,
          o = function (e) {
            '' !== e.style.zIndex
              ? (n = e.style.zIndex)
              : null !== e.offsetParent && void 0 !== e.offsetParent
              ? o(e.offsetParent)
              : null !== e.parentElement &&
                void 0 !== e.parentElement &&
                o(e.parentElement)
          }
        if (
          (o(e.target),
          ...
          switch (e.keyCode) {
              ...
              if ((b.keyStop(e, t), t.isInput)) {
                if (9 === e.keyCode && e.shiftKey)
                  return (
                    e.preventDefault(),
                    t.$selected &&
                      t.$selected.find('input, textarea, select').blur(),
                    void (
                      null !== t.$menu &&
                      void 0 !== t.$menu &&
                ...
                if (
                  38 === e.keyCode &&
                  'checkbox' ===
                    t.$selected.find('input, textarea, select').prop('type')
                )
            ...
            case 37:
              ...
              return (
                t.$selected.trigger('contextmenu:blur'), void (t.$selected = a)
              )
            case 39:
              if (
                (b.keyStop(e, t),
            ...
            case 36:
              return t.$selected &&
                t.$selected.find('input, textarea, select').length
                ? void 0
            ...
            default:
              ...
              if (t.accesskeys && t.accesskeys[i])
                return void t.accesskeys[i].$node.trigger(
                  t.accesskeys[i].$menu ? 'contextmenu:focus' : 'mouseup'
                )
          }
          e.stopPropagation(),
            void 0 !== t.$selected &&
      ...
      prevItem: function (e) {
        ...
        for (
          var a = t.$menu.children(),
            s =
              t.$selected && t.$selected.prev().length
                ? t.$selected.prev()
                : a.last(),
            i = s;
          s.hasClass(n.classNames.disabled) ||
          s.hasClass(n.classNames.notSelectable) ||
          s.is(':hidden');

        )
          if ((s = s.prev().length ? s.prev() : a.last()).is(i)) return
        t.$selected && b.itemMouseleave.call(t.$selected.get(0), e),
      ...
      nextItem: function (e) {
        ...
        for (
          var a = t.$menu.children(),
            s =
              t.$selected && t.$selected.next().length
                ? t.$selected.next()
                : a.first(),
            i = s;
          s.hasClass(n.classNames.disabled) ||
      ...
      itemMouseenter: function (e) {
        ...
        ;(a.hovering = !0),
          e &&
            a.$layer &&
            a.$layer.is(e.relatedTarget) &&
            (e.preventDefault(), e.stopImmediatePropagation()),
          (o.$menu ? o : a).$menu
            .children('.' + a.classNames.hover)
            .trigger('contextmenu:blur')
            .children('.hover')
            .trigger('contextmenu:blur'),
          t.hasClass(a.classNames.disabled) ||
          t.hasClass(a.classNames.notSelectable)
            ? (o.$selected = null)
      ...
      itemMouseleave: function (e) {
        ...
        ;(o && o.$menu && o.$menu.hasClass('context-menu-visible')) ||
      ...
      itemClick: function (e) {
        ...
        if (
          !(
            ...
            (n.is('.context-menu-submenu') && !1 === s.selectableSubMenu)
          )
        ) {
          if (
            (e.preventDefault(),
            e.stopImmediatePropagation(),
            m.isFunction(a.callbacks[i]) &&
              Object.prototype.hasOwnProperty.call(a.callbacks, i))
          )
            t = a.callbacks[i]
          else {
          ...
          !1 !== t.call(s.$trigger, i, s, e)
            ? s.$menu.trigger('contextmenu:hide')
            : s.$menu.parent().length && $.update.call(s.$trigger, s)
        }
      },
      ...
      focusItem: function (e) {
        ...
        t.hasClass(a.classNames.disabled) ||
          t.hasClass(a.classNames.notSelectable) ||
          (t
            .addClass([a.classNames.hover, a.classNames.visible].join(' '))
            .parent()
          ...
          o &&
            o.$node &&
            o.$node.hasClass('context-menu-submenu') &&
            o.$node.addClass(a.classNames.hover),
    ...
    $ = {
      show: function (n, e, t) {
        ...
        if (
          ...
          (n.$trigger = o),
          !1 !== n.events.show.call(o, n))
        )
          if (!1 !== $.update.call(o, n)) {
            if ((n.position.call(o, n, e, t), n.zIndex)) {
              var s = n.zIndex
              'function' == typeof n.zIndex && (s = n.zIndex.call(o, n)),
                (a.zIndex =
                  (function (e) {
                    for (
                      var t = 0, n = e;
            ...
            $.layer.call(n.$menu, n, a.zIndex),
              n.$menu.find('ul').css('zIndex', a.zIndex + 1),
              n.$menu
                .css(a)
                [n.animation.show](n.animation.duration, function () {
                  o.trigger('contextmenu:visible'),
                    $.activated(n),
                    n.events.activated(n)
                }),
              o.data('contextMenu', n).addClass('context-menu-active'),
              m(document)
                .off('keydown.contextMenu')
                .on('keydown.contextMenu', b.key),
              n.autoHide &&
                m(document).on('mousemove.contextMenuAutoHide', function (e) {
                  var t = o.offset()
      ...
      hide: function (t, e) {
        var n = m(this)
        if (
          ((t = t || n.data('contextMenu') || {}),
          e || !t.events || !1 !== t.events.hide.call(n, t))
        ) {
          if (
            (n.removeData('contextMenu').removeClass('context-menu-active'),
            t.$layer)
          ) {
            setTimeout(
              ((o = t.$layer),
      ...
      create: function (r, u) {
        function d(e) {
          ...
          if (e._accesskey)
            e._beforeAccesskey &&
              t.append(document.createTextNode(e._beforeAccesskey)),
              m('<span></span>')
                .addClass('context-menu-accesskey')
                .text(e._accesskey)
                .appendTo(t),
              e._afterAccesskey &&
                t.append(document.createTextNode(e._afterAccesskey))
        ...
        void 0 === u && (u = r),
          (r.$menu = m('<ul class="context-menu-list"></ul>')
            .addClass(r.className || '')
            .data({ contextMenu: r, contextMenuRoot: u })),
          r.dataAttr &&
            m.each(r.dataAttr, function (e, t) {
          ...
          m.each(r.items, function (n, o) {
            var e = m('<li class="context-menu-item"></li>').addClass(
                o.className || ''
              ),
              t = null,
              a = null
            if (
              (e.on('click', m.noop),
              ('string' != typeof o && 'cm_separator' !== o.type) ||
                (o = { type: 'cm_seperator' }),
              (o.$node = e.data({
                contextMenu: r,
                contextMenuRoot: u,
              ...
              for (
                ...
                if (!u.accesskeys[s]) {
                  var l = (u.accesskeys[s] = o).name.match(
                    new RegExp('^(.*?)(' + s + ')(.*)$', 'i')
                  )
                  l &&
                    ((o._beforeAccesskey = l[1]),
                    (o._accesskey = l[2]),
                    (o._afterAccesskey = l[3]))
                  break
                }
            if (o.type && v[o.type])
              v[o.type].call(e, o, r, u),
                m.each([r, u], function (e, t) {
                  ;(t.commands[n] = o),
                    !m.isFunction(o.callback) ||
                      (void 0 !== t.callbacks[n] && void 0 !== r.type) ||
                      (t.callbacks[n] = o.callback)
                })
            else {
              switch (
                ('cm_seperator' === o.type
                  ? e.addClass(
                      'context-menu-separator ' + u.classNames.notSelectable
                    )
                  : 'html' === o.type
                  ? e.addClass(
                      'context-menu-html ' + u.classNames.notSelectable
                    )
                  : 'sub' !== o.type && o.type
                  ? ((t = m('<label></label>').appendTo(e)),
                    d(o).appendTo(t),
                ...
                case 'cm_seperator':
                  break
                case 'text':
                  a = m('<input type="text" value="1" name="" />')
                    .attr('name', 'context-menu-input-' + n)
                    .val(o.value || '')
                    .appendTo(t)
                  break
                case 'textarea':
                  ;(a = m('<textarea name=""></textarea>')
                    .attr('name', 'context-menu-input-' + n)
                    .val(o.value || '')
                    .appendTo(t)),
                  ...
                  break
                case 'checkbox':
                  a = m('<input type="checkbox" value="1" name="" />')
                    .attr('name', 'context-menu-input-' + n)
                    .val(o.value || '')
                  ...
                  break
                case 'radio':
                  a = m('<input type="radio" value="1" name="" />')
                    .attr('name', 'context-menu-input-' + o.radio)
                    .val(o.value || '')
                    .prop('checked', !!o.selected)
                    .prependTo(t)
                  break
                case 'select':
                  ;(a = m('<select name=""></select>')
                    .attr('name', 'context-menu-input-' + n)
                    .appendTo(t)),
                    o.options &&
                      (m.each(o.options, function (e, t) {
                ...
                case 'sub':
                  d(o).appendTo(e),
                    ...
                    (o.callback = null),
                    'function' == typeof o.items.then
                      ? $.processPromises(o, u, o.items)
                      : $.create(o, u)
                  break
                case 'html':
                  m(o.html).appendTo(e)
              ...
              o.type &&
                ...
                'html' !== o.type &&
                'cm_seperator' !== o.type &&
                (a.on('focus', b.focusInput).on('blur', b.blurInput),
                o.events && a.on(o.events, r)),
                o.icon &&
                  (m.isFunction(o.icon)
                    ? (o._icon = o.icon.call(this, this, e, n, o))
                    : 'string' != typeof o.icon ||
                      ('fab ' !== o.icon.substring(0, 4) &&
                        'fas ' !== o.icon.substring(0, 4) &&
                        'fad ' !== o.icon.substring(0, 4) &&
                        'far ' !== o.icon.substring(0, 4) &&
                        'fal ' !== o.icon.substring(0, 4))
                    ? 'string' == typeof o.icon &&
                      'fa-' === o.icon.substring(0, 3)
                      ? (o._icon =
                          u.classNames.icon +
                          ' ' +
                          u.classNames.icon +
                      ...
                      : (o._icon =
                          ...
                          o.icon)
                    : (e.addClass(
                        u.classNames.icon + ' ' + u.classNames.icon + '--fa5'
                      ),
                      (o._icon = m('<i class="' + o.icon + '"></i>'))),
                  'string' == typeof o._icon
                    ? e.addClass(o._icon)
                    : e.prepend(o._icon))
            }
            ;(o.$input = a),
              ...
              e.appendTo(r.$menu),
              !r.hasTypes &&
                m.support.eventSelectstart &&
                e.on('selectstart.disableTextSelect', b.abortevent)
          }),
          r.$node ||
      ...
      resize: function (e, t) {
        var n
        e.css({ position: 'absolute', display: 'block' }),
          e.data(
            'width',
          ...
          e.css({ position: 'static', minWidth: '0px', maxWidth: '100000px' }),
        ...
        return (
          i.$menu.children().each(function () {
            var e,
              ...
              o = i.items[n],
              a =
                (m.isFunction(o.disabled) && o.disabled.call(l, n, c)) ||
                !0 === o.disabled
            if (
              ((e = m.isFunction(o.visible)
                ? o.visible.call(l, n, c)
                : void 0 === o.visible || !0 === o.visible) && (r = !0),
              t[e ? 'show' : 'hide'](),
            ...
            if (o.type)
              switch (
                (t.find('input, select, textarea').prop('disabled', a), o.type)
              ) {
                case 'text':
                case 'textarea':
                  o.$input.val(o.value || '')
      ...
      layer: function (e, t) {
        var n = (e.$layer = m('<div id="context-menu-layer"></div>')
          .css({
            height: p.height(),
            width: p.width(),
            display: 'block',
          ...
          .data('contextMenuRoot', e)
          .appendTo(document.body)
          .on('contextmenu', b.abortevent)
          .on('mousedown', b.layerClick))
        return (
          void 0 === document.body.style.maxWidth &&
            n.css({ position: 'absolute', height: m(document).height() }),
          n
        )
      },
  ...
  ;(m.fn.contextMenu = function (e) {
    ...
    if (0 < this.length)
      if (void 0 === e) this.first().trigger('contextmenu')
        ...
        'destroy' === e
          ? m.contextMenu('destroy', { context: this })
          : m.isPlainObject(e)
          ? ((e.context = this), m.contextMenu('create', e))
          : e
          ? this.removeClass('context-menu-disabled')
          : e || this.addClass('context-menu-disabled')
    else
      m.each(x, function () {
        this.selector === t.selector &&
          ((n.data = this), m.extend(n.data, { trigger: 'demand' }))
      }),
        b.contextmenu.call(n.target, n)
    return this
  }),
    (m.contextMenu = function (e, t) {
      'string' != typeof e && ((t = e), (e = 'create')),
        'string' == typeof t ? (t = { selector: t }) : void 0 === t && (t = {})
      var n = m.extend(!0, {}, g, t || {}),
        o = m(document),
        a = o,
        s = !1
      switch (
        (n.context && n.context.length
          ? ((a = m(n.context).first()),
            (n.context = a.get(0)),
            (s = !m(n.context).is(document)))
          : (n.context = document),
        e)
      ) {
        case 'update':
          if (s) $.update(a)
          else for (var i in x) x.hasOwnProperty(i) && $.update(x[i])
          break
        case 'create':
          if (!n.selector) throw new Error('No selector specified')
          if (n.selector.match(/.context-menu-(list|item|input)($|\s)/))
            throw new Error(
              'Cannot bind to selector "' +
                n.selector +
                '" as it contains a reserved className'
            )
          if (!n.build && (!n.items || m.isEmptyObject(n.items)))
            throw new Error('No Items specified')
          if (
            (f++,
            (n.ns = '.contextMenu' + f),
            s || (h[n.selector] = n.ns),
            (x[n.ns] = n).trigger || (n.trigger = 'right'),
            !d)
          ) {
            var c =
                'click' === n.itemClickEvent
                  ? 'click.contextMenu'
                  : 'mouseup.contextMenu',
              l = {
            ...
            ;(l[c] = b.itemClick),
              o
                ...
                .on('mouseup.contextMenu', '.context-menu-input', b.inputClick)
                .on(l, '.context-menu-item'),
              (d = !0)
          }
          switch (
            (a.on('contextmenu' + n.ns, n.selector, n, b.contextmenu),
            s &&
              a.on('remove' + n.ns, function () {
                m(this).contextMenu('destroy')
              }),
            n.trigger)
          ) {
            case 'hover':
              a.on('mouseenter' + n.ns, n.selector, n, b.mouseenter).on(
                'mouseleave' + n.ns,
                n.selector,
                n,
                b.mouseleave
        ...
        case 'destroy':
          ...
          if (s) {
            ...
            m.each(x, function (e, t) {
              ...
              ;(r = m('.context-menu-list').filter(':visible')).length &&
                r
                  .data()
                  .contextMenuRoot.$trigger.is(m(t.context).find(t.selector)) &&
                r.trigger('contextmenu:hide', { force: !0 })
              try {
            ...
            if (h[n.selector]) {
              ;(r = m('.context-menu-list').filter(':visible')).length &&
                r.data().contextMenuRoot.$trigger.is(n.selector) &&
                r.trigger('contextmenu:hide', { force: !0 })
              try {
                x[h[n.selector]].$menu && x[h[n.selector]].$menu.remove(),
                  delete x[h[n.selector]]
              } catch (e) {
                x[h[n.selector]] = null
              }
              o.off(h[n.selector])
          ...
          break
        case 'html5':
          ;((!m.support.htmlCommand && !m.support.htmlMenuitem) ||
            ('boolean' == typeof t && t)) &&
            m('menu[type="context"]')
              .each(function () {
                this.id &&
        ...
        (function s(i, e, c) {
          return (
            ...
            e.each(function () {
              ...
              switch (
                ('label' === a &&
                  n.find('input, textarea, select').length &&
                  ((e = n.text()),
                  (a = (o = (n = n.children().first()).get(
                    0
                  )).nodeName.toLowerCase())),
                a)
              ) {
                case 'menu':
                  ;(t = { name: n.attr('label'), items: {} }),
    ...
    (m.contextMenu.defaults = g),
    (m.contextMenu.types = v),
