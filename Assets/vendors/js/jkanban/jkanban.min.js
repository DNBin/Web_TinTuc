            ...
            function a(t, n) {
              t.addEventListener
                ? t.addEventListener(
                    ...
                    function (t) {
                      t.preventDefault(),
                        e.options.context(this, t),
                        'function' == typeof this.contextfn &&
                          this.contextfn(this, t)
                    },
                    !1
                  )
                : t.attachEvent('oncontextmenu', function () {
                    e.options.context(this),
                      'function' == typeof this.contextfn &&
                        this.contextfn(this),
            ...
            function l(t) {
              ...
              if (e.options.itemHandleOptions.enabled) {
                if (
                  ...
                  return (n =
                    '<div> ' +
                    e.options.itemHandleOptions.customHandler.replace(
                      /%([^%]+)%/g,
                      (e, n) => (void 0 !== t[n] ? t[n] : '')
                    ) +
                    ' </div>')
            ...
            arguments[0] &&
              ...
              (this.addBoards = function (t, n) {
                ...
                for (var p in t) {
                  ...
                  if ('' !== v.class && void 0 !== v.class)
                    var g = v.class.split(',')
                  else g = []
                  h.classList.add('kanban-board-header'),
                    g.map(function (e) {
                      ;(e = e.replace(/^[ ]+/g, '')), h.classList.add(e)
                    }),
                    (h.innerHTML =
                      '<div class="kanban-title-board">' + v.title + '</div>')
                  var y = document.createElement('main')
                  if (
                    (y.classList.add('kanban-drag'),
                    '' !== v.bodyClass && void 0 !== v.bodyClass)
                  )
                    var b = v.bodyClass.split(',')
                  else b = []
                  for (var w in (b.map(function (e) {
                    y.classList.add(e)
                  }),
                  e.boardContainer.push(y),
                  v.item)) {
                    var E = v.item[w],
                      T = document.createElement('div')
                    T.classList.add('kanban-item'),
                      E.id && (T.dataset.eid = E.id),
                      E.class &&
                        Array.isArray(E.class) &&
                        E.class.forEach(function (e) {
                          T.classList.add(e)
                        }),
                      (T.innerHTML = l(E)),
                      (T.clickfn = E.click),
                      (T.contextfn = E.context),
                      (T.dragfn = E.drag),
                      (T.dragendfn = E.dragend),
                      (T.dropfn = E.drop),
                      s(T, E),
                      r(T),
                      a(T),
                  ...
                  if (i) {
                    ...
                    C.setAttribute(
                      'class',
                      u || 'kanban-title-button btn btn-default btn-xs'
                    ),
                      C.appendChild(O),
                      f ? x.appendChild(C) : h.appendChild(C),
                      c(C, v.id)
                  }
                  m.appendChild(h),
                    m.appendChild(y),
              ...
              ((a = function (e, t, o) {
                return e.attachEvent(
                  ...
                  (function (e, t, o) {
                    ...
                    return d.push({ wrapper: i, element: e, type: t, fn: o }), i
                  })(e, t, o)
                )
              }),
              (c = function (e, t, n) {
                  ...
                  var a =
                    -1 === i.indexOf(t)
                      ...
                      : (function () {
                          var e
                          r.createEvent
                            ? (e = r.createEvent('Event')).initEvent(t, !0, !0)
                            : r.createEventObject && (e = r.createEventObject())
                          return e
                        })()
                  e.dispatchEvent
                    ? e.dispatchEvent(a)
    ...
    8: [
      function (e, t, n) {
        ...
        function a(e) {
          var t = o[e]
          return (
            t ? (t.lastIndex = 0) : (o[e] = t = new RegExp(i + e + r, 'g')), t
          )
        }
        t.exports = {
          add: function (e, t) {
            ...
            t.exports = function (e, t) {
                ...
                if (N)
                  if (0 !== s(e)) {
                    if (
                      !(
                        void 0 !== e.clientX &&
                        Math.abs(e.clientX - C) <= (A.slideFactorX || 0) &&
                        void 0 !== e.clientY &&
                        Math.abs(e.clientY - O) <= (A.slideFactorY || 0)
                      )
                    ) {
              ...
              function j(e) {
                if (!((_.dragging && n) || H(e))) {
                  ...
                  var o = h(e)
                  if (o && !A.invalid(e, t) && A.moves(e, o, t, y(e)))
              ...
              function z(e, t) {
                ...
                L && A.copySortSource && t === w && n.removeChild(E),
                  $(t) ? _.emit('cancel', e, w, w) : _.emit('drop', e, t, w, S),
                  G()
              }
              function V() {
                if (_.dragging) {
              ...
              function W(e) {
                if (_.dragging) {
                  ...
                  !1 === i &&
                    t &&
                    (L ? o && o.removeChild(L) : w.insertBefore(n, k)),
                    i || t
                      ? _.emit('cancel', n, w, w)
                      : _.emit('drop', n, o, w, S),
                    G()
              ...
              function $(e, t) {
                var o
                return (
                  (o = void 0 !== t ? t : n ? S : y(L || E)), e === w && o === k
                )
              }
              function J(e, t, n) {
              ...
              function Q(e) {
                if (n) {
                  ...
                  if (d !== w || !L || A.copySortSource) {
                    ...
                    ;((null === f && s) || (f !== a && f !== y(a))) &&
                      ((S = f), d.insertBefore(a, f), _.emit('shadow', a, d, w))
              ...
              function ee(e, t, n, o) {
                ...
                return t !== e
                  ? ((i = t.getBoundingClientRect()),
                    a(r ? n > i.left + v(i) / 2 : o > i.top + m(i) / 2))
                  : (function () {
                      var t,
                        i,
                        a,
    ...
    10: [
      function (e, t, n) {
        ...
        function p() {
          u &&
            s &&
            ((u = !1), s.length ? (l = s.concat(l)) : (f = -1), l.length && v())
        }
        function v() {
          if (!u) {
            var e = d(p)
