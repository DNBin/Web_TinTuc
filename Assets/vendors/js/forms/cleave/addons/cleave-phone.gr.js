...
*/
        ...
        return n.A
          ...
          ? ((e = T(n, t)),
            ...
            0 < l.length
              ? l
              : (F(n, n.a.toString()),
                B(n) ? V(n) : n.l ? G(n, e) : n.i.toString()))
          : M(n)
    }
  }
  function I(n) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        F(n, t), (t = D(n)), 0 < t.length ? t : B(n) ? V(n) : n.i.toString()
      )
    }
    return G(n, t)
  }
  ...
  function q(n) {
    ...
    return (
      ...
      n.a.a(l.toString()),
      (l = $(t)),
      '001' == l ? (n.g = j(n.G, '' + t)) : l != n.D && (n.g = E(n, l)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
