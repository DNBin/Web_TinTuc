...
*/
        ...
        return n.A
          ...
          ? ((e = T(n, t)),
            ...
            0 < l.length
              ? l
              : (C(n, n.a.toString()),
                F(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n)
    }
  }
  function $(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), V(n)
    )
  }
  function D(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        C(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? G(n) : n.i.toString()
      )
    }
    return M(n, t)
  }
  function G(n) {
    var t = n.a.toString(),
      e = t.length
    if (0 < e) {
      for (var r = '', l = 0; l < e; l++) r = T(n, t.charAt(l))
  ...
  var nn = { 297: ['AW'] },
    tn = {
      AW: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:28\\d|501)\\d{4}', null, null, null, '5011234'],
        'AW',
        297,
        '00',
        null,
