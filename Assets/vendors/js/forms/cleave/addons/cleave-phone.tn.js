        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < l.length
              ? l
              : ($(n, n.a.toString()),
                F(n) ? V(n) : n.l ? T(n, e) : n.i.toString()))
          : M(n)
    }
  }
  function I(n) {
    ...
    if (3 <= t.length) {
      for (
        ...
        ;(0 < n.h.length && A(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || A(g(i, 4)) || h(i, 6)) &&
            fn.test(g(i, 2)) &&
            n.f.push(i))
      }
      return (
        $(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? V(n) : n.i.toString()
      )
    }
    return T(n, t)
  }
...
*/
  var nn = { 216: ['TN'] },
    tn = {
      TN: [
        null,
        [null, null, '[2-57-9]\\d{7}', null, null, null, null, null, null, [8]],
        [
          null,
          null,
