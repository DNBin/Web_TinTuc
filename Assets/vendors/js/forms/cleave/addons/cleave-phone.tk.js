...
*/
        ...
        return n.A
          ...
          ? ((e = P(n, t)),
            ...
            0 < r.length
              ? r
              : (C(n, n.a.toString()),
                F(n) ? M(n) : n.l ? $(n, e) : n.i.toString()))
          : K(n)
    }
  }
  function D(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), K(n)
    )
  }
  function T(n) {
  ...
  function K(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        C(n, t), (t = T(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString()
      )
    }
    return $(n, t)
  }
  function M(n) {
    var t = n.a.toString(),
      e = t.length
    if (0 < e) {
      for (var l = '', r = 0; r < e; r++) l = P(n, t.charAt(r))
      return n.l ? $(n, l) : n.i.toString()
    }
    return n.b.toString()
  }
  function V(n) {
