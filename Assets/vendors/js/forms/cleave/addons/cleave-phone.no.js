...
*/
        ...
        return n.A
          ...
          ? ((t = P(n, l)),
            ...
            0 < u.length
              ? u
              : (F(n, n.a.toString()),
                R(n) ? O(n) : n.l ? J(n, t) : n.i.toString()))
          : M(n)
    }
  }
  function I(n) {
  ...
  function M(n) {
    ...
    if (3 <= l.length) {
      ...
      return (
        F(n, l), (l = D(n)), 0 < l.length ? l : R(n) ? O(n) : n.i.toString()
      )
    }
    return J(n, l)
  }
  ...
  function H(n) {
    ...
    return (
      ...
      n.a.a(u.toString()),
      (u = $(l)),
      '001' == u ? (n.g = j(n.G, '' + l)) : u != n.D && (n.g = B(n, u)),
      n.b.a('' + l).a(' '),
      (n.h = ''),
      !0)
    )
