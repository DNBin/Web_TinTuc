...
*/
  ...
  function R(n) {
    ;(this.H = RegExp(' ')),
      ...
      (this.f = []),
      (this.D = n),
      (this.J = this.g = $(this, this.D))
  }
  function $(n, l) {
    var t
    if (null != l && isNaN(l) && l.toUpperCase() in ln) {
      if (((t = E(n.G, l)), null == t)) throw Error('Invalid region code: ' + l)
      t = g(t, 10)
    } else t = 0
    return (t = E(n.G, j(t))), null != t ? t : an
  }
  function B(n) {
        ...
        return n.A
          ...
          ? ((t = P(n, l)),
            ...
            0 < u.length
              ? u
              : (F(n, n.a.toString()),
                B(n) ? M(n) : n.l ? T(n, t) : n.i.toString()))
          : Y(n)
    }
  }
  function I(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), Y(n)
    )
  }
  function D(n) {
  ...
  function Y(n) {
    ...
    if (3 <= l.length) {
      ...
      return (
        F(n, l), (l = D(n)), 0 < l.length ? l : B(n) ? M(n) : n.i.toString()
      )
    }
    return T(n, l)
  }
  function M(n) {
    var l = n.a.toString(),
      t = l.length
    if (0 < t) {
      for (var e = '', u = 0; u < t; u++) e = P(n, l.charAt(u))
  ...
  function H(n) {
    ...
    return (
      ...
      n.a.a(u.toString()),
      (u = j(l)),
      '001' == u ? (n.g = E(n.G, '' + l)) : u != n.D && (n.g = $(n, u)),
      n.b.a('' + l).a(' '),
      (n.h = ''),
      !0)
    )
...
*/
  ...
  ;(R.prototype.K = function () {
    ;(this.C = ''),
      ...
      (this.f = []),
      (this.B = !1),
      this.g != this.J && (this.g = $(this, this.D))
  }),
