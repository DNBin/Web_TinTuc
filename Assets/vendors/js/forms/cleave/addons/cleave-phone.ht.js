...
*/
        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < r.length
              ? r
              : ($(n, n.a.toString()),
                F(n) ? M(n) : n.l ? H(n, e) : n.i.toString()))
          : T(n)
    }
  }
  function I(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), T(n)
    )
  }
  function D(n) {
  ...
  function T(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        $(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString()
      )
    }
    return H(n, t)
  }
...
*/
  var nn = { 509: ['HT'] },
    tn = {
      HT: [
        null,
        [null, null, '[2-489]\\d{7}', null, null, null, null, null, null, [8]],
        [
          null,
          null,
