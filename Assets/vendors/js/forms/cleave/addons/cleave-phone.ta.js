!function () {
  function n(n, l) {
    ...
    for (var u; t.length && (u = t.shift()); )
      t.length || void 0 === l ? (e = e[u] ? e[u] : (e[u] = {})) : (e[u] = l)
  }
  function l(n, l) {
    function t() {}
    ;(t.prototype = l.prototype),
      ...
      (n.N = function (n, t, e) {
        for (
          var u = Array(arguments.length - 2), r = 2;
          r < arguments.length;
          r++
        )
          u[r - 2] = arguments[r]
        return l.prototype[t].apply(n, u)
      })
  }
  function t(n, l) {
  ...
  function p(n, l) {
    for (var t = o(n.j()), e = 0; e < t.length; e++) {
      ...
      if (null != l.a[r]) {
        ...
        var i = 11 == u.a || 10 == u.a
        if (u.g)
          for (var u = c(l, r) || [], a = 0; a < u.length; a++) {
            var s = n,
              f = r,
              h = i ? u[a].clone() : u[a]
          ...
          (u = c(l, r)),
            i ? ((i = c(n, r)) ? p(i, u) : b(n, r, u.clone())) : b(n, r, u)
      }
    }
  }
  function c(n, l) {
    ...
    if (n.g) {
      if (!(l in n.b)) {
        ...
        if (null != t)
          if (u.g) {
            for (var r = [], i = 0; i < t.length; i++) r[i] = e.b(u, t[i])
            t = r
          } else t = e.b(u, t)
        return (n.b[l] = t)
      }
...
*/
  ...
  function R(n, l) {
    ...
    if (null != l && isNaN(l) && l.toUpperCase() in ln) {
      if (((t = j(n.G, l)), null == t)) throw Error('Invalid region code: ' + l)
      t = g(t, 10)
    } else t = 0
    return (t = j(n.G, E(t))), null != t ? t : an
  }
  function F(n) {
    for (var l = n.f.length, t = 0; t < l; ++t) {
      ...
      if (i) return (n.w = r), (n.B = pn.test(h(u, 4))), (n.s = 0), !0
    }
    return (n.l = !1)
  }
  function C(n, l) {
    for (var t = [], e = l.length - 3, u = n.f.length, r = 0; r < u; ++r) {
      var i = n.f[r]
      0 == m(i, 3)
        ? t.push(n.f[r])
        : ((i = h(i, 3, Math.min(e, m(i, 3) - 1))),
          0 == l.search(i) && t.push(n.f[r]))
    }
    n.f = t
  }
  function I(n, l) {
    n.i.a(l)
    var t = l
    if (un.test(t) || (1 == n.i.b.length && en.test(t))) {
      var u,
        t = l
      '+' == t ? ((u = t), n.u.a(t)) : ((u = tn[t]), n.u.a(u), n.a.a(u)),
        (l = u)
    } else (n.l = !1), (n.F = !0)
    if (!n.l) {
      if (!n.F)
        ...
        return n.A
          ...
          ? ((t = q(n, l)),
            ...
            0 < u.length
              ? u
              : (C(n, n.a.toString()),
                F(n) ? M(n) : n.l ? T(n, t) : n.i.toString()))
          : $(n)
    }
  }
  function D(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), $(n)
    )
  }
  function H(n) {
    for (var l = n.a.toString(), t = n.f.length, e = 0; e < t; ++e) {
      ...
      if (new RegExp('^(?:' + r + ')$').test(l))
        return (
          (n.B = pn.test(h(u, 4))),
          (l = l.replace(new RegExp(r, 'g'), h(u, 2))),
          T(n, l)
        )
    }
    return ''
  ...
  function T(n, l) {
    var t = n.b.b.length
    return n.B && 0 < t && ' ' != n.b.toString().charAt(t - 1)
      ? n.b + ' ' + l
      : n.b + l
  }
  function $(n) {
    ...
    if (3 <= l.length) {
      for (
        ...
        var r = t[u]
        ;(0 < n.h.length && N(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != n.h.length || n.o || N(g(r, 4)) || h(r, 6)) &&
            fn.test(g(r, 2)) &&
            n.f.push(r))
      }
      return (
        C(n, l), (l = H(n)), 0 < l.length ? l : F(n) ? M(n) : n.i.toString()
      )
    }
    return T(n, l)
  }
  function M(n) {
    var l = n.a.toString(),
      t = l.length
    if (0 < t) {
      for (var e = '', u = 0; u < t; u++) e = q(n, l.charAt(u))
      return n.l ? T(n, e) : n.i.toString()
    }
    return n.b.toString()
  }
  function V(n) {
    ...
    return (
      1 != h(n.g, 10)
        ? (l = !1)
        : ((l = n.a.toString()),
          (l = '1' == l.charAt(0) && '0' != l.charAt(1) && '1' != l.charAt(1))),
      l
        ? ((u = 1), n.b.a('1').a(' '), (n.o = !0))
        : null != n.g.a[15] &&
          ((l = new RegExp('^(?:' + h(n.g, 15) + ')')),
          (l = t.match(l)),
          null != l &&
            null != l[0] &&
            0 < l[0].length &&
            ((n.o = !0), (u = l[0].length), n.b.a(t.substring(0, u)))),
      e(n.a),
      n.a.a(t.substring(u)),
      t.substring(0, u)
    )
  ...
  function P(n) {
    ...
    n: {
      if (((l = n.a.toString()), 0 != l.length && '0' != l.charAt(0)))
        for (var r, i = l.length, a = 1; 3 >= a && a <= i; ++a)
          if (((r = parseInt(l.substring(0, a), 10)), r in nn)) {
            u.a(l.substring(a)), (l = r)
            break n
          }
      l = 0
    }
    return (
      ...
      n.a.a(u.toString()),
      (u = E(l)),
      '001' == u ? (n.g = j(n.G, '' + l)) : u != n.D && (n.g = R(n, u)),
      n.b.a('' + l).a(' '),
      (n.h = ''),
      !0)
    )
  ...
  function q(n, l) {
    ...
    if (0 <= t.substring(n.s).search(n.H)) {
      var u = t.search(n.H),
        t = t.replace(n.H, l)
      return e(n.m), n.m.a(t), (n.s = u), t.substring(0, n.s + 1)
    }
  ...
  ;(v.prototype.j = function () {
        ...
        n ||
          (W = n =
            y(d, {
              ...
              1: { name: 'general_desc', c: 11, type: _ },
              2: { name: 'fixed_line', c: 11, type: _ },
              3: { name: 'mobile', c: 11, type: _ },
              4: { name: 'toll_free', c: 11, type: _ },
              5: { name: 'premium_rate', c: 11, type: _ },
              6: { name: 'shared_cost', c: 11, type: _ },
              7: { name: 'personal_number', c: 11, type: _ },
              8: { name: 'voip', c: 11, type: _ },
              21: { name: 'pager', c: 11, type: _ },
              25: { name: 'uan', c: 11, type: _ },
              27: { name: 'emergency', c: 11, type: _ },
              28: { name: 'voicemail', c: 11, type: _ },
              29: { name: 'short_code', c: 11, type: _ },
              30: { name: 'standard_rate', c: 11, type: _ },
              31: { name: 'carrier_specific', c: 11, type: _ },
              33: { name: 'sms_services', c: 11, type: _ },
              24: { name: 'no_international_dialling', c: 11, type: _ },
    ...
    (S.prototype.b = function (n, l) {
      if (11 == n.a || 10 == n.a)
        return l instanceof f ? l : this.a(n.i.prototype.j(), l)
      if (14 == n.a) {
      ...
      if (((t = n.i), t === String)) {
        ...
        t === Number &&
        'string' == typeof l &&
        ('Infinity' === l || '-Infinity' === l || 'NaN' === l || X.test(l))
      )
        return Number(l)
      return l
    })
  var X = /^-?[0-9]+$/
  l(w, S),
    (w.prototype.a = function (n, l) {
      var t = new n.b()
      return (t.g = this), (t.a = l), (t.b = {}), t
    }),
    l(x, w),
    (x.prototype.b = function (n, l) {
...
*/
  var nn = { 290: ['SH', 'TA'] },
    ln = {
      SH: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '262\\d\\d', null, null, null, '26212', null, null, [5]],
        'SH',
        290,
        '00',
        null,
      ...
      TA: [
        null,
        [null, null, '8\\d{3}', null, null, null, null, null, null, [4]],
  ...
  ;(B.prototype.K = function () {
    ...
    (B.prototype.L = function (n) {
      return (this.C = I(this, n))
    }),
    n('Cleave.AsYouTypeFormatter', B),
    n('Cleave.AsYouTypeFormatter.prototype.inputDigit', B.prototype.L),
    n('Cleave.AsYouTypeFormatter.prototype.clear', B.prototype.K)
