  ...
  function p(n, t) {
    for (var e = o(n.j()), l = 0; l < e.length; l++) {
      ...
      if (null != t.a[i]) {
        ...
        var a = 11 == r.a || 10 == r.a
        if (r.g)
          for (var r = c(t, i) || [], u = 0; u < r.length; u++) {
            var s = n,
              f = i,
              h = a ? r[u].clone() : r[u]
          ...
          (r = c(t, i)),
            a ? ((a = c(n, i)) ? p(a, r) : b(n, i, r.clone())) : b(n, i, r)
      }
    }
  }
  function c(n, t) {
    ...
    if (n.g) {
      if (!(t in n.b)) {
        ...
        if (null != e)
          if (r.g) {
            for (var i = [], a = 0; a < e.length; a++) i[a] = l.b(r, e[a])
            e = i
          } else e = l.b(r, e)
        return (n.b[t] = e)
      }
...
*/
  ...
  function F(n) {
    for (var t = n.f.length, e = 0; e < t; ++e) {
      ...
      if (-1 != o.indexOf('|')) a = !1
        ...
        ;(o = o.replace(on, '\\d')), (o = o.replace(sn, '\\d')), l(a.m)
        var s
        s = a
        var u = g(u, 2),
      ...
      if (a) return (n.w = i), (n.B = pn.test(h(r, 4))), (n.s = 0), !0
    }
    return (n.l = !1)
  }
  function C(n, t) {
  ...
  function M(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), H(n)
    )
  }
  function $(n) {
  ...
  function q(n) {
    ...
    return (
      ...
      n.a.a(r.toString()),
      (r = E(t)),
      '001' == r ? (n.g = j(n.G, '' + t)) : r != n.D && (n.g = R(n, r)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
  ...
  var nn = { 692: ['MH'] },
    tn = {
      MH: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '635\\d{4}', null, null, null, '6351234'],
        'MH',
        692,
        '011',
        '1',
