    ...
    for (var e = o(n.j()), l = 0; l < e.length; l++) {
      ...
      if (null != t.a[i]) {
        ...
        if (r.g)
          ...
          (r = c(t, i)),
            u ? ((u = c(n, i)) ? p(u, r) : $(n, i, r.clone())) : $(n, i, r)
      }
    }
  }
  function c(n, t) {
...
*/
        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < r.length
              ? r
              : (B(n, n.a.toString()),
                E(n) ? V(n) : n.l ? K(n, e) : n.i.toString()))
          : M(n)
    }
  }
  function I(n) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      for (
        ...
        var i = e[r]
        ;(0 < n.h.length && x(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || x(g(i, 4)) || h(i, 6)) &&
            fn.test(g(i, 2)) &&
            n.f.push(i))
      }
      return (
        B(n, t), (t = D(n)), 0 < t.length ? t : E(n) ? V(n) : n.i.toString()
      )
    }
    return K(n, t)
  }
  ...
  function P(n) {
    ...
    return (
      ...
      n.a.a(r.toString()),
      (r = N(t)),
      '001' == r ? (n.g = A(n.G, '' + t)) : r != n.D && (n.g = R(n, r)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
