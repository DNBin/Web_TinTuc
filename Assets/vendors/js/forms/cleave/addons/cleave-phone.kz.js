    ...
    for (var t = o(n.j()), e = 0; e < t.length; e++) {
      ...
      if (null != l.a[u]) {
        ...
        if (r.g)
          ...
          (r = c(l, u)),
            i ? ((i = c(n, u)) ? p(i, r) : b(n, u, r.clone())) : b(n, u, r)
      }
    }
  }
  function c(n, l) {
...
*/
  ...
  function C(n, l) {
    ...
    if (rn.test(t) || (1 == n.i.b.length && en.test(t))) {
      var r,
        t = l
      '+' == t ? ((r = t), n.u.a(t)) : ((r = tn[t]), n.u.a(r), n.a.a(r)),
        (l = r)
    } else (n.l = !1), (n.F = !0)
    if (!n.l) {
      if (!n.F)
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ? (G(n) && (n.A = !1), n.b.toString() + n.a.toString())
          : 0 < n.f.length
          ? ((t = H(n, l)),
            (r = D(n)),
            0 < r.length
              ? r
              : (F(n, n.a.toString()),
                B(n) ? M(n) : n.l ? U(n, t) : n.i.toString()))
          : K(n)
    }
  }
  function I(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), K(n)
    )
  }
  function D(n) {
    for (var l = n.a.toString(), t = n.f.length, e = 0; e < t; ++e) {
      var r = n.f[e],
        u = g(r, 1)
      if (new RegExp('^(?:' + u + ')$').test(l))
        return (
          (n.B = pn.test(h(r, 4))),
          (l = l.replace(new RegExp(u, 'g'), h(r, 2))),
          U(n, l)
        )
    }
    return ''
      ...
      l
        ...
        : null != n.g.a[15] &&
          ...
          null != l &&
            null != l[0] &&
            0 < l[0].length &&
            ((n.o = !0), (r = l[0].length), n.b.a(t.substring(0, r)))),
      e(n.a),
      n.a.a(t.substring(r)),
      t.substring(0, r)
    )
  ...
  function G(n) {
    ...
    return (
      ...
      n.a.a(r.toString()),
      (r = j(l)),
      '001' == r ? (n.g = N(n.G, '' + l)) : r != n.D && (n.g = E(n, r)),
      n.b.a('' + l).a(' '),
      (n.h = ''),
      !0)
    )
