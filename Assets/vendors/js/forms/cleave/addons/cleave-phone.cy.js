!function () {
  function n(n, t) {
    ...
    for (var l; e.length && (l = e.shift()); )
      e.length || void 0 === t ? (r = r[l] ? r[l] : (r[l] = {})) : (r[l] = t)
  }
  function t(n, t) {
    function e() {}
    ;(e.prototype = t.prototype),
      ...
      (n.N = function (n, e, r) {
        for (
          var l = Array(arguments.length - 2), i = 2;
          i < arguments.length;
          i++
        )
          l[i - 2] = arguments[i]
        return t.prototype[e].apply(n, l)
      })
  }
  function e(n, t) {
  ...
  function p(n, t) {
    for (var e = o(n.j()), r = 0; r < e.length; r++) {
      var l = e[r],
        i = l.b
      if (null != t.a[i]) {
        n.b && delete n.b[l.b]
        var a = 11 == l.a || 10 == l.a
        if (l.g)
          for (var l = c(t, i) || [], u = 0; u < l.length; u++) {
            var s = n,
              f = i,
              h = a ? l[u].clone() : l[u]
          ...
          (l = c(t, i)),
            a ? ((a = c(n, i)) ? p(a, l) : b(n, i, l.clone())) : b(n, i, l)
      }
    }
  }
  function c(n, t) {
    ...
    if (n.g) {
      if (!(t in n.b)) {
        ...
        if (null != e)
          if (l.g) {
            for (var i = [], a = 0; a < e.length; a++) i[a] = r.b(l, e[a])
            e = i
          } else e = r.b(l, e)
        return (n.b[t] = e)
      }
  ...
  function y(n, t) {
    var e,
      r = []
    for (e in t) 0 != e && r.push(new s(e, t[e]))
    return new u(n, r)
  } /*
...
*/
  ...
  function B(n, t) {
    ...
    if (null != t && isNaN(t) && t.toUpperCase() in tn) {
      if (((e = j(n.G, t)), null == e)) throw Error('Invalid region code: ' + t)
      e = g(e, 10)
    } else e = 0
    return (e = j(n.G, E(e))), null != e ? e : un
  }
  function R(n) {
    for (var t = n.f.length, e = 0; e < t; ++e) {
      ...
      if (-1 != o.indexOf('|')) a = !1
        ...
        ;(o = o.replace(on, '\\d')), (o = o.replace(sn, '\\d')), r(a.m)
        var s
        s = a
        var u = g(u, 2),
        ...
        f.length < s.a.b.length
          ...
          0 < s.length ? (a.m.a(s), (a = !0)) : (a = !1)
      }
      if (a) return (n.w = i), (n.B = pn.test(h(l, 4))), (n.s = 0), !0
    }
    return (n.l = !1)
  }
  function F(n, t) {
    for (var e = [], r = t.length - 3, l = n.f.length, i = 0; i < l; ++i) {
      var a = n.f[i]
      0 == m(a, 3)
        ? e.push(n.f[i])
        : ((a = h(a, 3, Math.min(r, m(a, 3) - 1))),
          0 == t.search(a) && e.push(n.f[i]))
    }
    n.f = e
  }
  function I(n, t) {
    n.i.a(t)
    var e = t
    if (ln.test(e) || (1 == n.i.b.length && rn.test(e))) {
      var l,
        e = t
      '+' == e ? ((l = e), n.u.a(e)) : ((l = en[e]), n.u.a(l), n.a.a(l)),
        (t = l)
    } else (n.l = !1), (n.F = !0)
    if (!n.l) {
      if (!n.F)
        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < l.length
              ? l
              : (F(n, n.a.toString()),
                R(n) ? V(n) : n.l ? Y(n, e) : n.i.toString()))
          : M(n)
    }
  }
  function $(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), M(n)
    )
  }
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1)
      if (new RegExp('^(?:' + i + ')$').test(t))
        return (
          (n.B = pn.test(h(l, 4))),
          (t = t.replace(new RegExp(i, 'g'), h(l, 2))),
          Y(n, t)
        )
    }
    return ''
    ...
    if (3 <= t.length) {
      for (
        ...
        ;(0 < n.h.length && N(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || N(g(i, 4)) || h(i, 6)) &&
            fn.test(g(i, 2)) &&
            n.f.push(i))
      }
      return (
        F(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? V(n) : n.i.toString()
      )
    }
    return Y(n, t)
  }
  function V(n) {
    var t = n.a.toString(),
      e = t.length
    if (0 < e) {
      for (var r = '', l = 0; l < e; l++) r = q(n, t.charAt(l))
      return n.l ? Y(n, r) : n.i.toString()
    }
    return n.b.toString()
  }
  function G(n) {
      ...
      t
        ...
        : null != n.g.a[15] &&
          ...
          null != t &&
            null != t[0] &&
            0 < t[0].length &&
            ((n.o = !0), (l = t[0].length), n.b.a(e.substring(0, l)))),
      r(n.a),
      n.a.a(e.substring(l)),
      e.substring(0, l)
    )
  ...
  function P(n) {
    ...
    n: {
      if (((t = n.a.toString()), 0 != t.length && '0' != t.charAt(0)))
        for (var i, a = t.length, u = 1; 3 >= u && u <= a; ++u)
          if (((i = parseInt(t.substring(0, u), 10)), i in nn)) {
            l.a(t.substring(u)), (t = i)
            break n
          }
      t = 0
    }
    return (
      ...
      n.a.a(l.toString()),
      (l = E(t)),
      '001' == l ? (n.g = j(n.G, '' + t)) : l != n.D && (n.g = B(n, l)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
  ...
  function q(n, t) {
    ...
    if (0 <= e.substring(n.s).search(n.H)) {
      var l = e.search(n.H),
        e = e.replace(n.H, t)
      return r(n.m), n.m.a(e), (n.s = l), e.substring(0, n.s + 1)
    }
...
*/
  var nn = { 357: ['CY'] },
    tn = {
      CY: [
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:50|77)\\d{6}', null, null, null, '77123456'],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
  ...
  ;(C.prototype.K = function () {
    ...
    (C.prototype.L = function (n) {
      return (this.C = I(this, n))
    }),
    n('Cleave.AsYouTypeFormatter', C),
    n('Cleave.AsYouTypeFormatter.prototype.inputDigit', C.prototype.L),
    n('Cleave.AsYouTypeFormatter.prototype.clear', C.prototype.K)
