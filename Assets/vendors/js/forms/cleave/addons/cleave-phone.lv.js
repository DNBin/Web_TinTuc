...
*/
        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < l.length
              ? l
              : ($(n, n.a.toString()),
                F(n) ? M(n) : n.l ? D(n, e) : n.i.toString()))
          : L(n)
    }
  }
  function I(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), L(n)
    )
  }
  function V(n) {
  ...
  function L(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        $(n, t), (t = V(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString()
      )
    }
    return D(n, t)
  }
  ...
  function P(n) {
    ...
    return (
      ...
      n.a.a(l.toString()),
      (l = E(t)),
      '001' == l ? (n.g = j(n.G, '' + t)) : l != n.D && (n.g = R(n, l)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
