...
*/
        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < r.length
              ? r
              : ($(n, n.a.toString()),
                R(n) ? V(n) : n.l ? K(n, e) : n.i.toString()))
          : M(n)
    }
  }
  function C(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), M(n)
    )
  }
  function I(n) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        $(n, t), (t = I(n)), 0 < t.length ? t : R(n) ? V(n) : n.i.toString()
      )
    }
    return K(n, t)
  }
  ...
  function P(n) {
    ...
    return (
      ...
      n.a.a(r.toString()),
      (r = E(t)),
      '001' == r ? (n.g = j(n.G, '' + t)) : r != n.D && (n.g = D(n, r)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
...
*/
  var nn = { 45: ['DK'] },
    tn = {
      DK: [
        null,
        [null, null, '[2-9]\\d{7}', null, null, null, null, null, null, [8]],
        [
          null,
          null,
