...
*/
        ...
        return n.A
          ...
          ? ((e = P(n, t)),
            ...
            0 < r.length
              ? r
              : (R(n, n.a.toString()),
                B(n) ? M(n) : n.l ? U(n, e) : n.i.toString()))
          : L(n)
    }
  }
  function I(n) {
  ...
  function L(n) {
    ...
    if (3 <= t.length) {
      for (
        ...
        var i = e[r]
        ;(0 < n.h.length && C(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || C(g(i, 4)) || h(i, 6)) &&
            fn.test(g(i, 2)) &&
            n.f.push(i))
      }
      return (
        R(n, t), (t = D(n)), 0 < t.length ? t : B(n) ? M(n) : n.i.toString()
      )
    }
    return U(n, t)
  }
  ...
  function H(n) {
    ...
    return (
      ...
      n.a.a(r.toString()),
      (r = N(t)),
      '001' == r ? (n.g = A(n.G, '' + t)) : r != n.D && (n.g = E(n, r)),
      n.b.a('' + t).a(' '),
      (n.h = ''),
      !0)
    )
