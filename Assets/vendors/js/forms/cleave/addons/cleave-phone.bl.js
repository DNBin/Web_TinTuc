    ...
    for (var u = o(l.j()), t = 0; t < u.length; t++) {
      ...
      if (null != n.a[r]) {
        ...
        if (e.g)
          ...
          (e = c(n, r)),
            i ? ((i = c(l, r)) ? p(i, e) : b(l, r, e.clone())) : b(l, r, e)
      }
    }
  }
  function c(l, n) {
        ...
        return l.A
          ...
          ? ((u = q(l, n)),
            ...
            0 < e.length
              ? e
              : (R(l, l.a.toString()),
                $(l) ? P(l) : l.l ? D(l, u) : l.i.toString()))
          : G(l)
    }
  }
  function I(l) {
    return (
      (l.l = !0), (l.A = !1), (l.f = []), (l.s = 0), t(l.m), (l.w = ''), G(l)
    )
  }
  function M(l) {
    ...
    if (3 <= n.length) {
      for (
        ...
        ;(0 < l.h.length && N(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != l.h.length || l.o || N(g(r, 4)) || h(r, 6)) &&
            sl.test(g(r, 2)) &&
            l.f.push(r))
      }
      return (
        R(l, n), (n = M(l)), 0 < n.length ? n : $(l) ? P(l) : l.i.toString()
      )
    }
    return D(l, n)
  }
