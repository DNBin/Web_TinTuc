...
*/
        ...
        return n.A
          ...
          ? ((e = q(n, t)),
            ...
            0 < l.length
              ? l
              : (R(n, n.a.toString()),
                C(n) ? V(n) : n.l ? M(n, e) : n.i.toString()))
          : O(n)
    }
  }
  function I(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), O(n)
    )
  }
  function D(n) {
  ...
  function O(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        R(n, t), (t = D(n)), 0 < t.length ? t : C(n) ? V(n) : n.i.toString()
      )
    }
    return M(n, t)
  }
...
*/
  var nn = { 298: ['FO'] },
    tn = {
      FO: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:6[0-36]|88)\\d{4}', null, null, null, '601234'],
        'FO',
        298,
        '00',
        null,
  ...
  ;(F.prototype.K = function () {
    ...
    (F.prototype.L = function (n) {
      return (this.C = $(this, n))
    }),
    n('Cleave.AsYouTypeFormatter', F),
    n('Cleave.AsYouTypeFormatter.prototype.inputDigit', F.prototype.L),
    n('Cleave.AsYouTypeFormatter.prototype.clear', F.prototype.K)
