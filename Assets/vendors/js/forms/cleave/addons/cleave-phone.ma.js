...
*/
  ...
  function B(n, l) {
    ...
    return (t = N(n.G, E(t))), null != t ? t : an
  }
  function R(n) {
        ...
        return n.A
          ...
          ? ((t = T(n, l)),
            ...
            0 < u.length
              ? u
              : (F(n, n.a.toString()),
                R(n) ? V(n) : n.l ? D(n, t) : n.i.toString()))
          : H(n)
    }
  }
  function I(n) {
    return (
      (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), H(n)
    )
  }
  function M(n) {
  ...
  function H(n) {
    ...
    if (3 <= l.length) {
      for (
        ...
        var r = t[u]
        ;(0 < n.h.length && A(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != n.h.length || n.o || A(g(r, 4)) || h(r, 6)) &&
            fn.test(g(r, 2)) &&
            n.f.push(r))
      }
      return (
        F(n, l), (l = M(n)), 0 < l.length ? l : R(n) ? V(n) : n.i.toString()
      )
    }
    return D(n, l)
  }
  function V(n) {
    var l = n.a.toString(),
      t = l.length
    if (0 < t) {
      for (var e = '', u = 0; u < t; u++) e = T(n, l.charAt(u))
  ...
  function q(n) {
    ...
    return (
      ...
      n.a.a(u.toString()),
      (u = E(l)),
      '001' == u ? (n.g = N(n.G, '' + l)) : u != n.D && (n.g = B(n, u)),
      n.b.a('' + l).a(' '),
      (n.h = ''),
      !0)
    )
...
*/
  var nn = { 212: ['MA', 'EH'] },
    ln = {
      EH: [
        null,
        [null, null, '[5-8]\\d{8}', null, null, null, null, null, null, [9]],
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '5924[01]\\d{4}', null, null, null, '592401234'],
        'EH',
        212,
        '00',
        '0',
