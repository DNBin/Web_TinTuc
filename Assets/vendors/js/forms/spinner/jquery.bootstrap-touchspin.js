  ...
  D.fn.TouchSpin = function (k) {
    ...
    return this.each(function () {
      var i,
        ...
        f = !1
      function b() {
        '' === i.prefix && (o = p.prefix.detach()),
          '' === i.postfix && (s = p.postfix.detach())
      }
      function h() {
        var t, n, o
      ...
      function g() {
        ...
        isNaN(a) ? (a = x()) : ((t = v()), (a += t)),
          null !== i.max &&
            a > i.max &&
            ((a = i.max), c.trigger('touchspin.on.max'), y()),
          p.input.val(
            i.callback_after_calculation(Number(a).toFixed(i.decimals))
          ),
      ...
      function m() {
        ...
        isNaN(a) ? (a = x()) : ((t = v()), (a -= t)),
          null !== i.min &&
            a < i.min &&
            ((a = i.min), c.trigger('touchspin.on.min'), y()),
          p.input.val(
            i.callback_after_calculation(Number(a).toFixed(i.decimals))
          ),
          n !== a && c.trigger('change')
      ...
      !(function () {
        ...
        ;(i = D.extend(
          ...
          (p = {
            ...
            input: D('input', u),
            prefix: D('.bootstrap-touchspin-prefix', u).addClass(
              i.prefix_extraclass
            ),
            postfix: D('.bootstrap-touchspin-postfix', u).addClass(
          ...
          p.down.on('mousedown.touchspin', function (t) {
            p.down.off('touchstart.touchspin'),
              c.is(':disabled') ||
                (m(), w(), t.preventDefault(), t.stopPropagation())
          }),
          ...
          p.up.on('mousedown.touchspin', function (t) {
            p.up.off('touchstart.touchspin'),
              c.is(':disabled') ||
                (g(), _(), t.preventDefault(), t.stopPropagation())
          }),
            ...
            !(function (t) {
              ;(function (t) {
                if (((i = D.extend({}, i, t)), t.postfix)) {
                  0 ===
                    c.parent().find('.bootstrap-touchspin-postfix').length &&
                    s.insertAfter(c),
                    c
                      .parent()
                ...
                if (t.prefix) {
                  0 === c.parent().find('.bootstrap-touchspin-prefix').length &&
                    o.insertBefore(c),
                    c
                      .parent()
