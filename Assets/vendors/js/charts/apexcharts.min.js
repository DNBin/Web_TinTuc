                  ...
                  i.config.xaxis.convertedCatToNumeric &&
                    (a = t.map(function (t, a) {
                      return i.config.xaxis.labels.formatter(
                        t - i.globals.minX + 1,
                        { i: a, dateFormatter: new y(e.ctx).formatDate, w: i }
                      )
                    })),
                  a
                )
            ...
            value: function (t, e) {
              ...
              if (this.annoCtx.invertAxis) {
                ...
                if (s.config.yaxis[e.yAxisIndex].logarithmic)
                  o =
                    (a = new w(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) /
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              a.config.yaxis[t.yAxisIndex].logarithmic
                ? (o =
                    (l = new w(this.annoCtx.ctx).getLogVal(l, t.yAxisIndex)) /
    ...
    L = (function () {
      function t(i) {
        e(this, t),
          ...
          (this.pointsAnnotations = new A(this)),
                  ...
                  n = function () {
                    ...
                    if (n > a) {
                      ...
                      for (var l = 0; l < s.length; l++)
                        n < s[l].breakpoint &&
                          ((t = w.extendArrayProps(r, s[l].options, i)),
                          (t = f.extend(i.config, t)),
                          e.overrideResponsiveOptions(t))
                  }
                if (t) {
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                ...
                ;(S.background = a[o]),
                  (S.color = a[o]),
                  S.setProperty('background', a[o], 'important'),
                  t.config.legend.markers.fillColors &&
                    t.config.legend.markers.fillColors[o] &&
                    (S.background = t.config.legend.markers.fillColors[o]),
                  void 0 !== t.globals.seriesColors[o] &&
                    ((S.background = t.globals.seriesColors[o]),
                    (S.color = t.globals.seriesColors[o])),
                  (S.height = Array.isArray(m)
                    ? parseFloat(m[o]) + 'px'
                    : parseFloat(m) + 'px'),
                  (S.width = Array.isArray(v)
                    ? parseFloat(v[o]) + 'px'
                    : parseFloat(v) + 'px'),
                  (S.left = Array.isArray(p) ? p[o] : p),
                  (S.top = Array.isArray(x) ? x[o] : x),
                  (S.borderWidth = Array.isArray(y) ? y[o] : y),
                  (S.borderColor = Array.isArray(k) ? k[o] : k),
                  (S.borderRadius = Array.isArray(A)
                    ? parseFloat(A[o]) + 'px'
                    : parseFloat(A) + 'px'),
                ...
                L.classList.add('apexcharts-legend-text'),
                  (L.innerHTML = Array.isArray(l) ? l.join(' ') : l)
                var P = t.config.legend.labels.useSeriesColors
                  ? t.globals.colors[o]
                ...
                P || (P = t.config.chart.foreColor),
                  ...
                  (L.style.fontWeight = t.config.legend.fontWeight),
                  (L.style.fontFamily = e || t.config.chart.fontFamily),
                  b.setAttrs(L, {
                    rel: o + 1,
                    i: o,
                ...
                if (!t.config.legend.showForZeroSeries)
                  0 === T.getSeriesTotalByIndex(o) &&
                    T.seriesHaveSameValues(o) &&
                    !T.isSeriesNull(o) &&
                    -1 === t.globals.collapsedSeriesIndices.indexOf(o) &&
                    -1 ===
                      t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) &&
                    C.classList.add('apexcharts-hidden-zero-series')
                t.config.legend.showForNullSeries ||
                  (T.isSeriesNull(o) &&
                    -1 === t.globals.collapsedSeriesIndices.indexOf(o) &&
                    -1 ===
                      t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) &&
                    C.classList.add('apexcharts-hidden-null-series')),
                  t.globals.dom.elLegendWrap.appendChild(C),
                  ...
                  C.classList.add('apexcharts-legend-series'),
                  (C.style.margin = ''
                  ...
                  (h || c) && C.classList.add('apexcharts-inactive-legend'),
                  t.config.legend.onItemClick.toggleDataSeries ||
                    C.classList.add('apexcharts-no-click')
              }
            ...
            value: function (t) {
              ...
              for (
                var p = function (t, r) {
                    ...
                    if (h.globals.axisCharts) {
                      ...
                      o
                        ? ((p = i.getFormatters(x)),
                          ...
                          (f = h.globals.colors[x]),
                          (e = b(x)))
                        : (l &&
                            l.target &&
                            l.target.getAttribute('fill') &&
                            (f = l.target.getAttribute('fill')),
                          (e = b(a)))
                    }
                    null === s && (e = p.yLbFormatter(h.globals.series[a], h)),
                      i.DOMHandling({
                        i: a,
                        t: x,
                        j: s,
                  ...
                  x = 0,
                  b = h.globals.series.length - 1;
                x < h.globals.series.length;
                x++, b--
              )
                p(x, b)
            },
        ...
        a(s, [
          {
            ...
            value: function (t, e) {
              var i = this,
                a = this.w
              ;(this.graphics = new b(this.ctx)),
                (this.bar = new Y(this.ctx, this.xyRatios))
              ...
              for (var g = 0; g < t.length; g++) {
                ...
                if (
                  ...
                  if (
                    ...
                    void 0 !== T &&
                      (L = T(i.globals.seriesPercent[g][0], {
                        seriesIndex: g,
                        w: i,
                      }))
              ...
              if (
                ...
                t.forEach(function (t, o) {
                  ...
                  t.forEach(function (t, a) {
                    var s = new T(e.ctx).getMarkerConfig(
                        'apexcharts-marker',
                        o,
                        a
                      ),
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                new w(this.lineCtx.ctx, i).seriesHaveSameValues(t)
              ) {
                var a = e[t].slice()
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              for (var l = [], h = 0; h < t.length; h++) {
                ...
                this._handlePaths({ type: r, realIndex: c, i: h, paths: y }),
                ...
                o.forEach(function (r) {
                  ...
                  return (
                    ...
                    e &&
                      'object' === t(e) &&
                      ((r.config = new R(e)),
                      (e = w.extendArrayProps(r.config, e, o)),
