...
!(function (t, e) {
  ...
  var f = {
      ...
      show: function (t, e, n) {
        ...
        ;(r =
          ...
          (r =
            'touches' in t && t.touches.length
              ? ((i = t.touches[0].pageY - a.top), t.touches[0].pageX - a.left)
              : ((i = t.pageY - a.top), t.pageX - a.left))
            ? r
            : 0),
          (i = 0 <= i ? i : 0)
        ...
        n && (u = 'translate(' + n.x + 'px, ' + n.y + 'px)'),
          ...
          o.setAttribute('data-x', r),
          o.setAttribute('data-y', i),
          o.setAttribute('data-scale', s),
          o.setAttribute('data-translate', u)
        var c = { top: i + 'px', left: r + 'px' }
        o.classList.add('waves-notransition'),
          o.setAttribute('style', m(c)),
          o.classList.remove('waves-notransition'),
          (c['-webkit-transform'] = s + ' ' + u),
          (c['-moz-transform'] = s + ' ' + u),
          (c['-ms-transform'] = s + ' ' + u),
          (c['-o-transform'] = s + ' ' + u),
          (c.transform = s + ' ' + u),
        ...
        ;(c['-webkit-transition-duration'] = l + 'ms'),
          (c['-moz-transition-duration'] = l + 'ms'),
          (c['-o-transition-duration'] = l + 'ms'),
          (c['transition-duration'] = l + 'ms'),
          o.setAttribute('style', m(c))
      },
      hide: function (t, e) {
        for (
          ...
          i(t, e, n[o])
        s &&
          (e.removeEventListener('touchend', f.hide),
          e.removeEventListener('touchcancel', f.hide)),
          e.removeEventListener('mouseup', f.hide),
          e.removeEventListener('mouseleave', f.hide)
      },
    },
    u = {
      input: function (t) {
        ...
        ;('i' === i.tagName.toLowerCase() &&
          ...
          (((e = document.createElement('i')).className =
            t.className + ' waves-input-wrapper'),
          (t.className = 'waves-button-input'),
          i.replaceChild(e, t),
          e.appendChild(t),
          (o = (n = window.getComputedStyle(t, null)).color),
          (a = n.backgroundColor),
          e.setAttribute('style', 'color:' + o + ';background:' + a),
  ...
  function i(t, e, n) {
    ...
    n &&
      ...
      (o = n.getAttribute('data-x')),
      (a = n.getAttribute('data-y')),
      (i = n.getAttribute('data-scale')),
      (r = n.getAttribute('data-translate')),
      (s = 350 - (Date.now() - Number(n.getAttribute('data-hold')))) < 0 &&
        (s = 0),
      'mousemove' === t.type && (s = 150),
      (u = 'mousemove' === t.type ? 2500 : f.duration),
      setTimeout(function () {
        var t = {
          top: a + 'px',
          left: o + 'px',
      ...
      c.registerEvent(e),
        'touchstart' === e.type && f.delay
          ? ((n = !1),
            ...
            (a = function (t) {
              o && (clearTimeout(o), (o = null), f.show(e, r)),
                n || ((n = !0), f.hide(t, r)),
                i()
            }),
            (t = function (t) {
            ...
            r.addEventListener('touchcancel', a, !1),
            (i = function () {
              r.removeEventListener('touchmove', t),
                r.removeEventListener('touchend', a),
                r.removeEventListener('touchcancel', a)
            }))
          : (f.show(e, r),
            s &&
              (r.addEventListener('touchend', f.hide, !1),
              r.addEventListener('touchcancel', f.hide, !1)),
            r.addEventListener('mouseup', f.hide, !1),
            r.addEventListener('mouseleave', f.hide, !1))
    }
  }
  return (
    (e.init = function (t) {
      var e = document.body
      'duration' in (t = t || {}) && (f.duration = t.duration),
        'delay' in t && (f.delay = t.delay),
        s &&
    ...
    (e.attach = function (t, e) {
      var n, o
      ;(t = l(t)),
        '[object Array]' === r.call(e) && (e = e.join(' ')),
        (e = e ? ' ' + e : '')
      for (var a = 0, i = t.length; a < i; a++)
        (o = (n = t[a]).tagName.toLowerCase()),
          -1 !== ['input', 'img'].indexOf(o) &&
            (u[o](n), (n = n.parentElement)),
    ...
    (e.ripple = function (t, e) {
      ...
      if (
        ...
        for (
          ...
          var s = t[a],
            u = e.position || { x: s.clientWidth / 2, y: s.clientHeight / 2 },
            c = d(s)
          ;(o.x = c.left + u.x),
            (o.y = c.top + u.y),
            (i.pageX = o.x),
            ...
            0 <= e.wait &&
              null !== e.wait &&
              setTimeout(r({ type: 'mouseup', button: 1 }, s), e.wait)
        }
    }),
    (e.calm = function (t) {
      for (
        var e = { type: 'mouseup', button: 1 }, n = 0, o = (t = l(t)).length;
        n < o;
        n++
      )
        f.hide(e, t[n])
