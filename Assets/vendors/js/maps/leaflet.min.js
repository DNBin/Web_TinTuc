!(function (t, i) {
  ...
  function M(t, i, e) {
    if (!e || T !== b) return T.call(window, s(t, i))
    t.call(i)
  }
  function C(t) {
    t && z.call(window, t)
  ...
  ;(E.extend = function (t) {
    ...
    var o = (i.__super__ = this.prototype),
      s = n(o)
    for (var r in (((s.constructor = i).prototype = s), this))
  ...
  function bi(t) {
    ...
    t.style &&
      (Ti(),
      (ti = (Qt = t).style.outline),
      (t.style.outline = 'none'),
      Si(window, 'keydown', Ti))
  }
  function Ti() {
    Qt &&
      ((Qt.style.outline = ti), (ti = Qt = void 0), Zi(window, 'keydown', Ti))
  }
  function zi(t) {
    for (
      ;
  ...
  function Si(t, i, e, n) {
    ...
    else for (var s = 0, r = (i = d(i)).length; s < r; s++) ki(t, i[s], e, n)
    return this
  }
  var Ei = '_leaflet_events'
  function Zi(t, i, e, n) {
    if ('object' == typeof i) for (var o in i) Bi(t, o, i[o], e)
    else if (i)
      for (var s = 0, r = (i = d(i)).length; s < r; s++) Bi(t, i[s], e, n)
    else {
      for (var a in t[Ei]) Bi(t, a, t[Ei][a])
      delete t[Ei]
    }
    return this
  }
    ...
    bt && 0 === i.indexOf('touch')
            ...
            ? (function (t, i, e) {
                ...
                ;(t['_leaflet_touchstart' + e] = n),
                  ...
                  Wt ||
                    ...
                    document.documentElement.addEventListener(Nt, Vt, !0),
                    (Wt = !0))
              })(t, e, n)
            : 'touchmove' === i
            ? (function (t, i, e) {
      ...
      : (function (t, i, e) {
          ...
          ;(t[Yt + Gt + e] = r),
            (t[Yt + Kt + e] = a),
            (t[Yt + 'dblclick' + e] = i),
            t.addEventListener(Gt, r, !!St && { passive: !1 }),
            t.addEventListener(Kt, a, !!St && { passive: !1 }),
    ...
    bt && 0 === i.indexOf('touch')
      ...
      : (function (t, i) {
          var e = t[Yt + Gt + i],
            n = t[Yt + Kt + i],
            o = t[Yt + 'dblclick' + i]
          t.removeEventListener(Gt, e, !!St && { passive: !1 }),
            t.removeEventListener(Kt, n, !!St && { passive: !1 }),
  ...
  function Oi(t) {
    return Si(t, 'mousedown touchstart dblclick', Ai), ki(t, 'click', Ui), this
  }
  function Ri(t) {
  ...
  var Gi = (Object.freeze || Object)({
    ...
    Yi = k.extend({
      ...
      flyTo: function (t, i, e) {
        if (!1 === (e = e || {}).animate || !yt) return this.setView(t, i, e)
        this._stop()
        ...
        var f = Date.now(),
          g = (_(1) - m) / l,
          v = e.duration ? 1e3 * e.duration : 1e3 * g * 0.8
        return (
      ...
      locate: function (t) {
        ...
        var i = s(this._handleGeolocationResponse, this),
      ...
      _initContainer: function (t) {
        ...
        Si(i, 'scroll', this._onScroll, this), (this._containerId = a(i))
      },
      ...
      _findEventTargets: function (t, i) {
        ...
        return n.length || r || o || !qi(s, t) || (n = [this]), n
      },
      ...
      _createAnimProxy: function () {
        var t = (this._proxy = ri('div', 'leaflet-proxy leaflet-zoom-animated'))
      ...
      _animMoveEnd: function () {
        var t = this.getCenter(),
          i = this.getZoom()
        vi(this._proxy, this.project(t, i), this.getZoomScale(i, 1))
      },
  ...
  var $i = Ji.extend({
      ...
      addTo: function (t) {
        return Ji.prototype.addTo.call(this, t), this._expandIfNotCollapsed()
      },
      onRemove: function () {
      ...
      collapse: function () {
        return di(this._container, 'leaflet-control-layers-expanded'), this
      },
      _initLayout: function () {
        ...
        e &&
          ...
          st ||
            Si(i, { mouseenter: this.expand, mouseleave: this.collapse }, this))
      ...
      _getLayer: function (t) {
        for (var i = 0; i < this._layers.length; i++)
          if (this._layers[i] && a(this._layers[i].layer) === t)
      ...
      _addItem: function (t) {
        ...
        t.overlay
          ? (((i = document.createElement('input')).type = 'checkbox'),
            ...
            (i.defaultChecked = n))
          : (i = this._createRadioElement('leaflet-base-layers_' + a(this), n)),
  ...
  var te = Ji.extend({
    ...
    ie = Ji.extend({
      ...
      onAdd: function (t) {
        for (var i in (((t.attributionControl = this)._container = ri(
          'div',
  ...
  var ne,
    oe = { Events: Z },
    se = Tt ? 'touchstart mousedown' : 'mousedown',
    re = {
      mousedown: 'mouseup',
      touchstart: 'touchend',
    ...
    he = k.extend({
      ...
      disable: function () {
        this._enabled &&
          ...
          Zi(this._dragStartTarget, se, this._onDown, this),
          (this._enabled = !1),
          (this._moved = !1))
      },
      _onDown: function (t) {
        if (
          ...
          !ci(this._element, 'leaflet-zoom-anim') &&
            !(
              ...
              ((he._dragging = this)._preventOutline && bi(this._element),
              Pi(),
              Xt(),
              this._moving)
            ))
      ...
      finishDrag: function () {
        ...
        ae))
          Zi(document, ae[t], this._onMove, this),
            Zi(document, re[t], this._onUp, this)
        Li(),
          Jt(),
          this._moved &&
            this._moving &&
  ...
  var ye,
    xe = (Object.freeze || Object)({ clipPolygon: ve }),
    we = {
      project: function (t) {
    ...
    be = e({}, U, {
      code: 'EPSG:3395',
      projection: Pe,
      transformation: ((ye = 0.5 / (Math.PI * Pe.R)), K(ye, 0.5, -ye, 0.5)),
    }),
    Te = e({}, U, {
      code: 'EPSG:4326',
      projection: we,
  ...
  var Ce = Me.extend({
      ...
      addLayer: function (t) {
        return this.hasLayer(t)
          ...
          : (t.addEventParent(this),
            Ce.prototype.addLayer.call(this, t),
      ...
      removeLayer: function (t) {
        return this.hasLayer(t)
          ? (t in this._layers && (t = this._layers[t]),
            ...
            Ce.prototype.removeLayer.call(this, t),
      ...
      _getIconUrl: function (t) {
        return (
          ...
          (this.options.imagePath || Ze.imagePath) +
            Ee.prototype._getIconUrl.call(this, t)
        )
      },
    ...
    Be = Me.extend({
      ...
      _updateOpacity: function () {
        ...
        this._icon && fi(this._icon, t), this._shadow && fi(this._shadow, t)
      },
    ...
    Ie = Ae.extend({
      ...
      setStyle: function (t) {
        ...
        return Ae.prototype.setStyle.call(this, t), this.setRadius(i), this
      },
      _project: function () {
    ...
    Oe = Ie.extend({
      ...
      setStyle: Ae.prototype.setStyle,
      _project: function () {
    ...
    Re = Ae.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var i, e, n = 1 / 0, o = null, s = pe, r = 0, a = this._parts.length;
          r < a;
          r++
        )
  ...
  var Ne = Re.extend({
      ...
      _convertLatLngs: function (t) {
        var i = Re.prototype._convertLatLngs.call(this, t),
          e = i.length
        return (
          2 <= e && i[0] instanceof j && i[0].equals(i[e - 1]) && i.pop(), i
        )
      },
      _setLatLngs: function (t) {
        Re.prototype._setLatLngs.call(this, t),
          me(this._latlngs) && (this._latlngs = [this._latlngs])
      },
      _defaultShape: function () {
        return me(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0]
      },
      _clipPoints: function () {
        var t = this._renderer._bounds,
        ...
        if (
          ...
          if (this.options.noClip) this._parts = this._rings
            ...
            for (var n, o = 0, s = this._rings.length; o < s; o++)
              (n = ve(this._rings[o], t, !0)).length && this._parts.push(n)
      },
      _updatePath: function () {
  ...
  function je(t, i) {
    ...
    switch (r.type) {
      ...
      case 'MultiLineString':
        return (n = Fe(a, 'LineString' === r.type ? 0 : 1, l)), new Re(n, i)
      case 'Polygon':
      case 'MultiPolygon':
        return (n = Fe(a, 'Polygon' === r.type ? 1 : 2, l)), new Ne(n, i)
  ...
  function We(t, i, e, n) {
    return t ? t(i, e) : new Be(e, n && n.markersInheritOptions && n)
  }
  function He(t) {
  ...
  function Fe(t, i, e) {
    for (var n, o = [], s = 0, r = t.length; s < r; s++)
      (n = i ? Fe(t[s], i - 1, e) : (e || He)(t[s])), o.push(n)
    return o
  }
  function Ue(t, i) {
    return (
  ...
  function Ve(t, i, e, n) {
    for (var o = [], s = 0, r = t.length; s < r; s++)
      o.push(i ? Ve(t[s], i - 1, e, n) : Ue(t[s], n))
    return !i && e && o.push(o[0]), o
  }
  function qe(t, i) {
    return t.feature ? e({}, t.feature, { geometry: i }) : Ge(i)
  }
  function Ge(t) {
  ...
  var Ke = {
    toGeoJSON: function (t) {
      return qe(this, { type: 'Point', coordinates: Ue(this.getLatLng(), t) })
    },
  }
  function Ye(t, i) {
    return new De(t, i)
    ...
    Re.include({
      toGeoJSON: function (t) {
        ...
        return qe(this, {
          ...
          coordinates: Ve(this._latlngs, i ? 1 : 0, !1, t),
        })
      },
    }),
    Ne.include({
      toGeoJSON: function (t) {
        var i = !me(this._latlngs),
          ...
          n = Ve(this._latlngs, e ? 2 : i ? 1 : 0, !0, t)
        return (
          i || (n = [n]),
          qe(this, { type: (e ? 'Multi' : '') + 'Polygon', coordinates: n })
        )
      },
    }),
    Ce.include({
      toMultiPoint: function (t) {
        ...
        return (
          ...
          qe(this, { type: 'MultiPoint', coordinates: i })
        )
      },
      toGeoJSON: function (t) {
        var i =
  ...
  var Xe = Ye,
    Je = Me.extend({
      ...
      _initImage: function () {
        ...
        _i(i, 'leaflet-image-layer'),
          ...
          (i.onselectstart = l),
          (i.onmousemove = l),
          (i.onload = s(this.fire, this, 'load')),
          (i.onerror = s(this._overlayOnError, this, 'error')),
    ...
    $e = Je.extend({
      ...
      _initImage: function () {
        ...
        if (
          ...
          (i.onselectstart = l),
          (i.onmousemove = l),
          (i.onloadeddata = s(this.fire, this, 'load')),
          t)
        ) {
          for (
    ...
    Qe = Je.extend({
      _initImage: function () {
        ...
        _i(t, 'leaflet-image-layer'),
          this._zoomAnimated && _i(t, 'leaflet-zoom-animated'),
          this.options.className && _i(t, this.options.className),
          (t.onselectstart = l),
          (t.onmousemove = l)
      },
    }),
    tn = Me.extend({
      ...
      _prepareOpen: function (t, i, e) {
        if ((i instanceof Me || ((e = i), (i = t)), i instanceof Se))
    ...
    en = tn.extend({
      ...
      onAdd: function (t) {
        tn.prototype.onAdd.call(this, t),
          ...
          this._source &&
            ...
            this._source instanceof Ae || this._source.on('preclick', Ai))
      },
      onRemove: function (t) {
        tn.prototype.onRemove.call(this, t),
          ...
          this._source &&
            ...
            this._source instanceof Ae || this._source.off('preclick', Ai))
      },
      getEvents: function () {
      ...
      _updateLayout: function () {
        ...
        o && o < n ? ((i.height = o + 'px'), _i(t, s)) : di(t, s),
  ...
  var nn = tn.extend({
    ...
    setOpacity: function (t) {
      ;(this.options.opacity = t), this._container && fi(this._container, t)
    },
    _animateZoom: function (t) {
  ...
  var sn = Me.extend({
      ...
      bringToFront: function () {
        return (
          this._map && (ui(this._container), this._setAutoZIndex(Math.max)),
          this
        )
      },
      bringToBack: function () {
      ...
      _invalidateAll: function () {
        for (var t in this._levels)
          ai(this._levels[t].el), this._onRemoveLevel(t), delete this._levels[t]
      ...
      _addTile: function (t, i) {
        ...
        this._initTile(o),
          this.createTile.length < 2 && M(s(this._tileReady, this, t, null, o)),
          yi(o, e),
    ...
    rn = sn.extend({
      ...
      createTile: function (t, i) {
        ...
        return (
          Si(e, 'load', s(this._tileOnLoad, this, i, e)),
          Si(e, 'error', s(this._tileOnError, this, i, e)),
          (!this.options.crossOrigin && '' !== this.options.crossOrigin) ||
            (e.crossOrigin =
              !0 === this.options.crossOrigin ? '' : this.options.crossOrigin),
          (e.alt = ''),
      ...
      _tileOnLoad: function (t, i) {
        et ? setTimeout(s(t, this, null, i), 0) : t(null, i)
      },
  ...
  var hn = rn.extend({
    ...
    getTileUrl: function (t) {
      var i = this._tileCoordsToNwSe(t),
        ...
        s = n.max,
        r = (
          1.3 <= this._wmsVersion && this._crs === Te
            ? [o.y, o.x, s.y, s.x]
            : [o.x, o.y, s.x, s.y]
        ).join(','),
  ...
  var un = Me.extend({
      ...
      onAdd: function () {
        this._container ||
          (this._initContainer(),
          this._zoomAnimated && _i(this._container, 'leaflet-zoom-animated')),
          this.getPane().appendChild(this._container),
          this._update(),
      ...
      _updateTransform: function (t, i) {
        ...
        yt ? vi(this._container, a, e) : yi(this._container, a)
      },
      _reset: function () {
    ...
    ln = un.extend({
      ...
      _initContainer: function () {
        ...
        Si(t, 'mousemove', this._onMouseMove, this),
          Si(
            t,
      ...
      _initPath: function (t) {
        ...
        var i = ((this._layers[a(t)] = t)._order = {
          layer: t,
          prev: this._drawLast,
          next: null,
        })
  ...
  var _n = (function () {
    ...
    dn = {
      ...
      _removePath: function (t) {
        var i = t._container
        ai(i), t.removeInteractiveTarget(i), delete this._layers[a(t)]
      },
      _updateStyle: function (t) {
        var i = t._stroke,
          e = t._fill,
  ...
  var gn = Ne.extend({
    initialize: function (t, i) {
      Ne.prototype.initialize.call(this, this._boundsToLatLngs(t), i)
    },
    setBounds: function (t) {
  ...
  ;(mn.create = pn),
    (mn.pointsToPath = Q),
    (De.geometryToLayer = je),
    (De.coordsToLatLng = He),
    (De.coordsToLatLngs = Fe),
    (De.latLngToCoords = Ue),
    (De.latLngsToCoords = Ve),
    (De.getFeature = qe),
    (De.asFeature = Ge),
  ...
  var vn = ee.extend({
    ...
    _finish: function () {
      this._moved && (ai(this._box), di(this._container, 'leaflet-crosshair')),
        Jt(),
        Li(),
        Zi(
          document,
  ...
  Tt && !bt && Yi.addInitHook('addHandler', 'tap', Ln),
    Yi.mergeOptions({ touchZoom: Tt && !rt, bounceAtZoomLimits: !0 })
  var bn = ee.extend({
    addHooks: function () {
    ...
    _onTouchMove: function (t) {
      if (t.touches && 2 === t.touches.length && this._zooming) {
        ...
        this._moved || (i._moveStart(!0, !1), (this._moved = !0)),
          C(this._animRequest)
        var a = s(i._move, i, this._center, this._zoom, {
          pinch: !0,
          round: !1,
        })
  ...
  Yi.addInitHook('addHandler', 'touchZoom', bn),
    (Yi.BoxZoom = vn),
    (Yi.DoubleClickZoom = yn),
    (Yi.Drag = xn),
    (Yi.Keyboard = wn),
    (Yi.ScrollWheelZoom = Pn),
    (Yi.Tap = Ln),
    (Yi.TouchZoom = bn),
    (Object.freeze = i),
    (t.version = '1.6.0'),
