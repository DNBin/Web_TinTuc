// Language detector i18n V6.0.1
!(function (e, o) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = o())
    : 'function' == typeof define && define.amd
    ? define(o)
    : ((e = e || self).i18nextBrowserLanguageDetector = o())
})(this, function () {
  'use strict'
  function e(e, o) {
  ...
  function i(e) {
    return (
      t.call(n.call(arguments, 1), function (o) {
  ...
  var a = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
    ...
    s = function (e, o, t, n) {
      ...
      t &&
        ...
        n && (i.domain = n),
        (document.cookie = r(e, encodeURIComponent(o), i))
    },
    u = function (e) {
      for (
    ...
    l = {
      ...
      cacheUserLanguage: function (e, o) {
        o.lookupCookie &&
          ...
          s(o.lookupCookie, e, o.cookieMinutes, o.cookieDomain, o.cookieOptions)
      },
    },
    c = {
      name: 'querystring',
      lookup: function (e) {
        ...
        if ('undefined' != typeof window)
          for (
            ...
            var i = t[n].indexOf('=')
            if (i > 0)
              t[n].substring(0, i) === e.lookupQuerystring &&
                (o = t[n].substring(i + 1))
          }
        return o
      },
