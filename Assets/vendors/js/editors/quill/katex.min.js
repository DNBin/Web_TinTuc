        ...
        E = (function () {
          function t(t, e, r, a, n, i, o, s) {
            ...
            l && this.classes.push(l + '_fallback'),
              /[\xee\xef\xed\xec]/.test(this.text) && (this.text = R[this.text])
          }
          var e = t.prototype
          return (
            (e.hasClass = function (t) {
            ...
            re(
              ...
              function (t, e) {
                ...
                'mbin' === r && c.contains(Jt, a)
                  ? (e.classes[0] = 'mord')
                  : 'mbin' === a && c.contains(Kt, r) && (t.classes[0] = 'mord')
              },
              { node: m },
              u,
              p
            ...
            re(
              ...
              function (t, e) {
                var r = ne(e),
                  a = ne(t),
                  n =
                    r && a ? (t.hasClass('mtight') ? Gt[r][a] : Ut[r][a]) : null
          ...
          handler: function (t) {
            ...
            for (
              ...
              if (1 !== (a = e.gullet.consumeArgs(1)[0]).length)
                throw new o('Invalid argument number length "' + a.length + '"')
          ...
          return (
            ...
            (e.handleInfixNodes = function (t) {
              for (var e, r = -1, a = 0; a < t.length; a++)
                if ('infix' === t[a].type) {
                  if (-1 !== r)
                    throw new o('only one infix operator per group', t[a].token)
