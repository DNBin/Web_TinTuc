...
!(function () {
  if (
    ...
    Prism.hooks.add('before-highlight', function (a) {
      a.grammar &&
        !a.grammar['url-link'] &&
        (Prism.languages.DFS(a.grammar, function (a, r, l) {
          t.indexOf(l) > -1 &&
        ...
        (a.grammar['url-link'] = i),
        (a.grammar['email-link'] = n))
    }),
      ...
      if (a && /pre/i.test(a.nodeName)) {
        var t,
          ...
          r =
            ...
            e[s.language] ||
            s.language.substring(0, 1).toUpperCase() + s.language.substring(1),
          l = a.previousSibling
        l &&
        ...
        /\s*\bprism-show-language-label\b\s*/.test(l.firstChild.className)
          ...
          : ((t = document.createElement('div')),
            ...
            (i.className = 'prism-show-language-label'),
            (t.className = 'prism-show-language'),
            t.appendChild(i),
  ...
  if (
    ...
    var e = {
      ...
      n = function (e, a) {
        ...
        !r &&
          a.parentNode &&
          'pre' === a.parentNode.tagName.toLowerCase() &&
          (r = a.parentNode.getAttribute('data-dependencies')),
          (r = r ? r.split(/\s*,\s*/g) : []),
          i(r, function () {
            t(e, function () {
        ...
        var u = function () {
            ...
            if (
              ...
              n &&
                ...
                i.success_callbacks.push(n)),
              t &&
                (i.error_callbacks || (i.error_callbacks = []),
                i.error_callbacks.push(t)),
              !e && Prism.languages[a])
            )
              l(a)
      ...
      l = function (e) {
        c[e] &&
          c[e].success_callbacks &&
          c[e].success_callbacks.length &&
          c[e].success_callbacks.forEach(function (c) {
            c(e)
          })
      },
      o = function (e) {
        c[e] &&
          c[e].error_callbacks &&
          c[e].error_callbacks.length &&
          c[e].error_callbacks.forEach(function (c) {
            c(e)
          })
      }
    Prism.hooks.add('complete', function (e) {
      ...
      if (e.code) {
        ...
        if (
          ...
          if ('' !== s) n = n.join('<span data-prompt="' + s + '"></span>')
            ...
            n = n.join(
              '<span data-user="' + r + '" data-host="' + l + '"></span>'
            )
          }
          ...
          for (var i = 0; i < o.length; i++) {
            var d = o[i].split('-'),
              ...
              c = p
            if (
              (2 === d.length && (c = parseInt(d[1])), !isNaN(p) && !isNaN(c))
            )
        ...
        if (
          ...
          for (
            var t = n.childNodes,
              ...
              i = '',
              o = !1,
              a = Prism.plugins.NormalizeWhitespace,
              l = 0;
            l < t.length;
            ++l
          ) {
            ...
            s == e.element
              ? (o = !0)
              : '#text' === s.nodeName &&
                (o ? (i += s.nodeValue) : (r += s.nodeValue),
                n.removeChild(s),
                --l)
          }
          if (e.element.children.length && Prism.plugins.KeepMarkup) {
            var u = r + e.element.innerHTML + i
            ;(e.element.innerHTML = a.normalize(u, e.settings)),
              (e.code = e.element.textContent)
          } else
            (e.code = r + e.code + i),
              (e.code = a.normalize(e.code, e.settings))
        }
      })
  }
})()
