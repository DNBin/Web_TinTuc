...
;(function (f) {
  ...
  function E(a, b) {
    y === w &&
      (y =
        -1 ===
        C.serializeToString(
          new g.DOMParser().parseFromString(
      ...
      if (f.isPlainObject(c)) (b = a.folder(b)), E(b, c)
        ...
        if (y) {
          ...
          for (e = d.attributes.length - 1; 0 <= e; e--) {
            ...
            ;-1 !== n.indexOf(':') &&
              (h.push({ name: n, value: k }), d.removeAttribute(n))
          }
          e = 0
    ...
    if (
      ...
      var b = a.document.createElementNS('http://www.w3.org/1999/xhtml', 'a'),
        ...
        h = function (c) {
          setTimeout(function () {
            'string' === typeof c
              ? (a.URL || a.webkitURL || a).revokeObjectURL(c)
              : c.remove()
          }, 4e4)
        },
        n = function (a) {
            ...
            (function () {
              if ((f || (g && c)) && a.FileReader) {
                ...
                b.onloadend = function () {
                  var c = f
                    ? b.result
                    : b.result.replace(/^data:[^;]*;/, 'data:attachment/file;')
                ...
                u || (u = (a.URL || a.webkitURL || a).createObjectURL(k)),
                  g
                    ? (a.location.href = u)
                    : a.open(u, '_blank') || (a.location.href = u),
                  (m.readyState = m.DONE),
                  D(),
                  h(u)
            })()
  ...
  var G = function (a) {
    ...
    I = function (a, b) {
      ...
      var c = b.fieldBoundary,
        ...
        n = function (a) {
          for (var b = '', d = 0, n = a.length; d < n; d++)
            0 < d && (b += f),
      ...
      for (var g = [], l = 0, q = a.body.length; l < q; l++)
        g.push(n(a.body[l]))
  ...
  v.ext.buttons.csvHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      !1 !== f
        ? (f || (f = l.characterSet || l.charset), f && (f = ';charset=' + f))
        : (f = '')
      c.bom && (a = '﻿' + a)
  ...
  v.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            g ||
              ...
              (a[b].match &&
                ...
                : ((m = m.replace
                    ? m.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')
                    : m),
                  (g = r(h, 'c', {
      ...
      var x = function (a, b) {
          ...
          c[0].appendChild(
            r(h, 'mergeCell', { attr: { ref: 'A' + a + ':' + A(b) + a } })
          )
      ...
      c.footer &&
        k.footer &&
        (q(k.footer, e), f('row:last c', h).attr('s', '2'))
      ...
      for (y = k.header.length; x < y; x++)
        q.appendChild(
          r(h, 'col', {
            attr: { min: x + 1, max: x + 1, width: L(k, x), customWidth: 1 },
          })
        )
      q = a.xl['workbook.xml']
      f('sheets sheet', q).attr('name', G(c))
      c.autoFilter &&
        (f('mergeCells', h).before(
          r(h, 'autoFilter', {
            attr: { ref: 'A' + d + ':' + A(k.header.length - 1) + t },
          })
        ),
