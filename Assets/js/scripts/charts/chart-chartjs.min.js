$(window).on('load', function () {
  ...
  if (
    ($('html').hasClass('dark-layout') && (x = '#b4b7bd'),
    o.length &&
      o.each(function () {
        $(this).wrap(
          $(
      ...
      options: {
        ...
        scales: {
          xAxes: [
            {
              display: !0,
              gridLines: { display: !0, color: k, zeroLineColor: k },
          ...
          yAxes: [
            {
              display: !0,
              gridLines: { color: k, zeroLineColor: k },
              ticks: { stepSize: 100, min: 0, max: 400, fontColor: x },
            },
          ],
        },
      },
  ...
  if (
      ...
      for (var x = 1; x < 4; x++) {
        ...
        ;(v = 20) > S / 2 && (v = S / 2),
          ...
          d.horizontal
            ? (n.moveTo(B + v, A),
              n.lineTo(B + m - v, A),
              n.quadraticCurveTo(B + m, A, B + m, A + v),
              n.lineTo(B + m, A + S - v),
              n.quadraticCurveTo(B + m, A + S, B + m - v, A + S),
              n.lineTo(B + v, A + S),
              n.quadraticCurveTo(B, A + S, B, A + S),
              n.lineTo(B, A + v),
              n.quadraticCurveTo(B, A, B, A))
            : (n.moveTo(B + v, A),
              n.lineTo(B + m - v, A),
              n.quadraticCurveTo(B + m, A, B + m, A + v),
              n.lineTo(B + m, A + S - v),
              n.quadraticCurveTo(B + m, A + S, B + m, A + S),
              n.lineTo(B + v, A + S),
              n.quadraticCurveTo(B, A + S, B, A + S),
              n.lineTo(B, A + v),
              n.quadraticCurveTo(B, A, B + v, A))
      }
      n.fill(), s && n.stroke()
    }),
    a.length &&
      new Chart(a, {
        type: 'horizontalBar',
        options: {
          elements: { rectangle: { borderWidth: 2, borderSkipped: 'right' } },
          tooltips: {
            shadowOffsetX: 1,
            shadowOffsetY: 1,
            shadowBlur: 8,
          ...
          responsiveAnimationDuration: 500,
          legend: { display: !1 },
          layout: { padding: { bottom: -30, left: -25 } },
          scales: {
            xAxes: [
              {
                display: !0,
    ...
    new Chart(e, {
      ...
      options: {
        ...
        layout: { padding: { top: -15, bottom: -25, left: -15 } },
        scales: {
          xAxes: [
            {
              display: !0,
        ...
        legend: {
          position: 'top',
          align: 'start',
          labels: { usePointStyle: !0, padding: 25, boxWidth: 9 },
        },
      },
      data: {
        labels: [
  ...
  if (i.length) {
    ...
    m.addColorStop(0, 'rgba(155,136,250, 0.9)'),
      m.addColorStop(1, 'rgba(155,136,250, 0.8)')
    var S = v.getContext('2d').createLinearGradient(0, 0, 0, 150)
    S.addColorStop(0, 'rgba(255,161,161, 0.9)'),
      S.addColorStop(1, 'rgba(255,161,161, 0.8)')
    new Chart(i, {
      type: 'radar',
      plugins: [
        {
      ...
      options: {
        ...
        maintainAspectRatio: !1,
        responsiveAnimationDuration: 500,
        legend: { position: 'top', labels: { padding: 25, fontColor: x } },
        ...
        gridLines: { display: !1 },
        scale: {
          ticks: { maxTicksLimit: 1, display: !1, fontColor: x },
          gridLines: { color: k },
          angleLines: { color: k },
        },
      },
  ...
  if (l.length)
    new Chart(l, {
      ...
      options: {
        ...
        legend: {
          position: 'right',
          labels: { usePointStyle: !0, padding: 25, boxWidth: 9, fontColor: x },
        },
          ...
          xAxes: [
            {
              display: !0,
              gridLines: { color: k, zeroLineColor: k },
              ticks: { stepSize: 10, min: 0, max: 140, fontColor: x },
            },
          ],
          yAxes: [
            {
      ...
      data: {
        ...
        datasets: [
          ...
          },
          {
            backgroundColor: C,
            borderColor: C,
            data: [{ x: 90, y: 250, r: 10 }],
          },
          {
            backgroundColor: C,
            borderColor: C,
            data: [{ x: 100, y: 220, r: 7 }],
          },
          {
            backgroundColor: C,
            borderColor: C,
            data: [{ x: 120, y: 230, r: 4 }],
          },
          {
            backgroundColor: C,
            borderColor: C,
            data: [{ x: 110, y: 320, r: 15 }],
          },
          {
            backgroundColor: C,
            borderColor: C,
            data: [{ x: 130, y: 330, r: 7 }],
          },
          {
            backgroundColor: p,
            borderColor: p,
            data: [{ x: 100, y: 310, r: 5 }],
          },
          {
            backgroundColor: p,
            borderColor: p,
            data: [{ x: 110, y: 240, r: 5 }],
          },
          {
            backgroundColor: p,
            borderColor: p,
            data: [{ x: 120, y: 270, r: 7 }],
          },
          {
            backgroundColor: p,
            borderColor: p,
            data: [{ x: 130, y: 300, r: 6 }],
          },
        ],
      },
    })
        ...
        tooltips: {
          callbacks: {
            label: function (o, r) {
              return (
                ' ' +
                (r.datasets[0].labels[o.index] || '') +
                ' : ' +
                r.datasets[0].data[o.index] +
                ' %'
              )
            },
          },
  ...
  c.length &&
    new Chart(c, {
      ...
      options: {
        ...
        layout: { padding: { top: -20, bottom: -20, left: -20 } },
        tooltips: {
          shadowOffsetX: 1,
          shadowOffsetY: 1,
          shadowBlur: 8,
        ...
        scales: {
          xAxes: [
            {
              display: !0,
              gridLines: { color: 'transparent', zeroLineColor: k },
              scaleLabel: { display: !0 },
              ticks: { fontColor: x },
            },
          ],
