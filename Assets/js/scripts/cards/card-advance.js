...
$(window).on('load', function () {
  ...
  var $employeeChartPrimary1 = document.querySelector(
    '.employee-task-chart-primary-1'
  )
  var $employeeChartDanger = document.querySelector(
    '.employee-task-chart-danger'
  )
  var $employeeChartSuccess = document.querySelector(
    '.employee-task-chart-success'
  )
  var $employeeChartSecondary = document.querySelector(
    '.employee-task-chart-secondary'
  )
  var $employeeChartWarning = document.querySelector(
    '.employee-task-chart-warning'
  )
  var $employeeChartPrimary2 = document.querySelector(
    '.employee-task-chart-primary-2'
  )
  ...
  employeePrimaryChart1 = new ApexCharts(
    $employeeChartPrimary1,
    employeePrimaryChartOptions1
  )
  ...
  employeeDangerChart = new ApexCharts(
    $employeeChartDanger,
    employeeDangerChartOptions
  )
  ...
  employeeSuccessChart = new ApexCharts(
    $employeeChartSuccess,
    employeeSuccessChartOptions
  )
  ...
  employeeSecondaryChart = new ApexCharts(
    $employeeChartSecondary,
    employeeSecondaryChartOptions
  )
  ...
  employeeWarningChart = new ApexCharts(
    $employeeChartWarning,
    employeeWarningChartOptions
  )
  ...
  employeePrimaryChart2 = new ApexCharts(
    $employeeChartPrimary2,
    employeePrimaryChartOptions2
  )
  ...
  statePrimaryChart = new ApexCharts(
    $stateChartPrimary,
    statePrimaryChartOptions
  )
  ...
  stateWarningChart = new ApexCharts(
    $stateChartWarning,
    stateWarningChartOptions
  )
  ...
  stateSecondaryChart = new ApexCharts(
    $stateChartSecondary,
    stateSecondaryChartOptions
  )
