!(function (e, t, s) {
  ...
  function u(e) {
    e.element
    return e.id
      ? feather.icons[s(e.element).data('icon')].toSvg() + e.text
      : e.text
  }
  i.each(function () {
    var e = s(this)
  ...
  n.wrap('<div class="position-relative"></div>').select2({
      ...
      templateResult: function (e) {
        ...
        e.description &&
          (t +=
            ...
            '</div>')
        return (t +=
          "<div class='select2-result-repository__statistics'><div class='select2-result-repository__forks'>" +
    ...
    s('#select2InModal').on('shown.bs.modal', function () {
      p.select2({ placeholder: 'Select a state' })
    })
