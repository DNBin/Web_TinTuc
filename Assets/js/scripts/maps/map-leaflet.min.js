$(function () {
  ...
  if (
    ('laravel' === $('body').attr('data-framework') &&
      (e = $('body').attr('data-asset-path')),
    $('#basic-map').length)
  ) {
    var o = L.map('basic-map').setView([42.35, -71.08], 10)
  ...
  if ($('#shape-map').length) {
    var r = L.map('shape-map').setView([51.5, -0.09], 12)
    L.marker([51.5, -0.09]).addTo(r),
  ...
  if ($('#drag-map').length) {
    var a = L.map('drag-map').setView([48.817152, 2.455], 12)
  ...
  if ($('#user-location').length) {
    var i = L.map('user-location').setView([42.35, -71.08], 10)
    function e(e) {
      var t = e.accuracy
      L.marker(e.latlng)
        .addTo(i)
  ...
  if ($('#custom-icons').length) {
    var n = L.map('custom-icons').setView([51.5, -0.09], 10),
      p = L.icon({
        iconUrl: e + 'images/misc/leaf-green.png',
        shadowUrl: e + 'images/misc/leaf-shadow.png',
        iconSize: [38, 95],
        shadowSize: [50, 64],
        iconAnchor: [22, 94],
        shadowAnchor: [4, 62],
      ...
      y = L.icon({
        iconUrl: e + 'images/misc/leaf-red.png',
        shadowUrl: e + 'images/misc/leaf-shadow.png',
        iconSize: [38, 95],
        shadowSize: [50, 64],
        iconAnchor: [22, 94],
      ...
      s = L.icon({
        iconUrl: e + 'images/misc/leaf-orange.png',
        shadowUrl: e + 'images/misc/leaf-shadow.png',
        iconSize: [38, 95],
        shadowSize: [50, 64],
        iconAnchor: [22, 94],
    ...
    L.marker([51.5, -0.09], { icon: y }).addTo(n),
      L.marker([51.4, -0.51], { icon: p }).addTo(n),
      L.marker([51.49, -0.45], { icon: s }).addTo(n),
      L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
        attribution:
          'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18,
  ...
  if ($('#geojson').length) {
    var d = L.map('geojson').setView([44.2669, -72.576], 3)
    function e(e) {
      return {
        fillColor:
          ((t = e.properties.density),
          t > 1e3
            ? '#800026'
            : t > 500
            ? '#BD0026'
  ...
  if ($('#layer-control').length) {
    var m = L.marker([39.61, -105.02]).bindPopup('This is Littleton, CO.'),
      g = L.marker([39.74, -104.99]).bindPopup('This is Denver, CO.'),
      l = L.marker([39.73, -104.8]).bindPopup('This is Aurora, CO.'),
      c = L.marker([39.77, -105.23]).bindPopup('This is Golden, CO.'),
      u = L.layerGroup([m, g, l, c]),
      h = L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
        attribution:
          'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18,
      }),
      P = L.tileLayer('http://tile.stamen.com/watercolor/{z}/{x}/{y}.jpg', {
        attribution:
          'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18,
      }),
      F = L.map('layer-control', {
        center: [39.73, -104.99],
        zoom: 10,
        layers: [h, u],
      }),
      w = { Street: h, Watercolor: P },
      f = { Cities: u }
    L.control.layers(w, f).addTo(F),
