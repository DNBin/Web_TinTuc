$(function () {
  var t = $('.validate-form'),
    ...
    n = 'app-invoice-preview.html',
    o = 'app-invoice-edit.html',
    s = $('.account-number-mask'),
    i = $('.account-zip-code'),
    l = $('.select2'),
    c = document.querySelector('.cancel-subscription')
  if (
    ('laravel' === $('body').attr('data-framework') &&
      ((e = $('body').attr('data-asset-path')),
      (n = e + 'app/invoice/preview'),
      (o = e + 'app/invoice/edit')),
    t.length &&
      t.each(function () {
        var t = $(this)
        t.validate({
    ...
    i.length &&
      i.each(function () {
        new Cleave($(this), { delimiter: '', numeral: !0 })
      }),
    l.length &&
      l.each(function () {
        var t = $(this)
    ...
    a.DataTable({
      ...
      columnDefs: [
        { className: 'control', responsivePriority: 2, targets: 0 },
        {
          targets: 1,
          width: '46px',
          render: function (t, e, a, o) {
            var s = a.invoice_id
            return '<a class="fw-bold" href="' + n + '"> #' + s + '</a>'
          },
        },
        {
          targets: 2,
          ...
          render: function (t, e, a, n) {
            ...
            return (
              ...
              s +
              '</span>\'><div class="avatar avatar-status ' +
              i[o].class +
              '"><span class="avatar-content">' +
              feather.icons[i[o].icon].toSvg({ class: 'avatar-icon' }) +
              '</span></div></span>'
            )
          },
        },
        ...
        },
        {
          ...
          width: '130px',
          render: function (t, e, a, n) {
            var o = new Date(a.issued_date)
            return moment(o).format('DD MMM YYYY')
          },
        },
        {
          targets: 5,
        ...
        { targets: 7, visible: !1 },
        {
          ...
          render: function (t, e, a, s) {
            return (
              '<div class="d-flex align-items-center col-actions"><a class="me-1" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Send Mail">' +
              feather.icons.send.toSvg({ class: 'font-medium-2 text-body' }) +
              '</a><a class="me-25" href="' +
              n +
              '" data-bs-toggle="tooltip" data-bs-placement="top" title="Preview Invoice">' +
              feather.icons.eye.toSvg({ class: 'font-medium-2 text-body' }) +
              '</a><div class="dropdown"><a class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown">' +
              ...
              'Edit</a><a href="#" class="dropdown-item">' +
              feather.icons.trash.toSvg({ class: 'font-small-4 me-50' }) +
              'Delete</a><a href="#" class="dropdown-item">' +
      ...
      responsive: {
        details: {
          ...
          renderer: function (t, e, a) {
            var n = $.map(a, function (t, e) {
              return 2 !== t.columnIndex
                ? '<tr data-dt-row="' +
                    t.rowIdx +
                    '" data-dt-column="' +
                    t.columnIndex +
            ...
            return (
              !!n &&
              $('<table class="table"/>').append('<tbody>' + n + '</tbody>')
            )
          },
        },
      },
