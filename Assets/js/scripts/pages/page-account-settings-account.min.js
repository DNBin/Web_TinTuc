$(function () {
  var t = $('.validate-form'),
    e = $('#account-upload-img'),
    n = $('#account-upload'),
    c = $('.uploadedAvatar'),
    o = $('#account-reset'),
    a = $('.account-number-mask'),
    i = $('.account-zip-code'),
    u = $('.select2'),
    r = document.querySelector('#formAccountDeactivation'),
    l = r.querySelector('.deactivate-account')
  if (c) {
    var s = c.attr('src')
  ...
  const d = document.querySelector('#accountActivation')
  l &&
    (l.onclick = function () {
      1 == d.checked &&
        Swal.fire({
