...
$(function () {
    ...
    if (mailDelete.length) {
        mailDelete.on('click', function () {
            if (
                userActions.find('.form-check .form-check-input:checked').length
            ) {
                userActions
    ...
    if (emailSearch.length) {
        emailSearch.on('keyup', function () {
            ...
            if (value !== '') {
                ...
                var tbl_row = emailUserList.find(
                    '.email-media-list li:visible'
                ).length
