      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (t, a, e, n) {
            ...
            return (
              ...
              feather.icons[o[s].icon].toSvg({ class: 'avatar-icon' }) +
              '</span></div></span>'
            )
          },
        },
        {
          ...
          render: function (t, e, n, s) {
            ...
            if (((r = ((r.shift() || '') + (r.pop() || '')).toUpperCase()), l))
              var c =
                '<img  src="' +
                a +
                'images/avatars/' +
            ...
            else c = '<div class="avatar-content">' + r + '</div>'
            return (
              '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar' +
              ('' === l ? ' bg-light-' + d + ' ' : ' ') +
              'me-50">' +
              c +
              '</div></div><div class="d-flex flex-column"><h6 class="user-name text-truncate mb-0">' +
              i +
              '</h6><small class="text-truncate text-muted">' +
              o +
              '</small></div></div>'
            )
          },
