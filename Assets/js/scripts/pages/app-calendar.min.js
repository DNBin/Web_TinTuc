  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var E = new FullCalendar.Calendar(t, {
      ...
      eventClick: function (t) {
        !(function (t) {
          ;(e = t.event).url &&
            (t.jsEvent.preventDefault(), window.open(e.url, '_blank')),
            a.modal('show'),
            d.addClass('d-none'),
            r.addClass('d-none'),
            ...
            !0 === e.allDay ? m.prop('checked', !0) : m.prop('checked', !1),
            null !== e.end
    ...
    $(d).on('click', function () {
      if (l.valid()) {
        ...
        p.val().length && (e.url = p.val()),
          m.prop('checked') && (e.allDay = !0),
          (t = e),
          E.addEvent(t),
          E.refetchEvents()
      }
      ...
      y.length &&
        y.on('change', function () {
          $('.input-filter:checked').length < b.find('input').length
            ? g.prop('checked', !1)
            : g.prop('checked', !0),
            E.refetchEvents()
        })
