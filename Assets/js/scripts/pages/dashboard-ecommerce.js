...
$(window).on('load', function () {
  ...
  var $statisticsProfitChart = document.querySelector(
  ...
  var $browserStateChartPrimary = document.querySelector(
    '#browser-state-chart-primary'
  )
  var $browserStateChartWarning = document.querySelector(
    '#browser-state-chart-warning'
  )
  var $browserStateChartSecondary = document.querySelector(
    '#browser-state-chart-secondary'
  )
  var $browserStateChartInfo = document.querySelector(
    '#browser-state-chart-info'
  )
  var $browserStateChartDanger = document.querySelector(
    '#browser-state-chart-danger'
  )
  var $goalOverviewChart = document.querySelector(
  ...
  statisticsOrderChart = new ApexCharts(
    $statisticsOrderChart,
    statisticsOrderChartOptions
  )
  ...
  browserStatePrimaryChart = new ApexCharts(
    $browserStateChartPrimary,
    browserStatePrimaryChartOptions
  )
  ...
  browserStateWarningChart = new ApexCharts(
    $browserStateChartWarning,
    browserStateWarningChartOptions
  )
  ...
  browserStateSecondaryChart = new ApexCharts(
    $browserStateChartSecondary,
    browserStateSecondaryChartOptions
  )
  ...
  browserStateInfoChart = new ApexCharts(
    $browserStateChartInfo,
    browserStateInfoChartOptions
  )
  ...
  browserStateDangerChart = new ApexCharts(
    $browserStateChartDanger,
    browserStateDangerChartOptions
  )
  ...
  goalOverviewChart = new ApexCharts(
    $goalOverviewChart,
    goalOverviewChartOptions
  )
