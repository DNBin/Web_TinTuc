$(function () {
  var e = document.querySelector('.create-app-wizard'),
    t = document.getElementById('createAppModal'),
    n = '../../../app-assets/',
    a = $('.create-app-card-mask'),
    i = $('.create-app-expiry-date-mask'),
    c = $('.create-app-cvv-code-mask')
  if (
    ('laravel' === $('body').attr('data-framework') &&
      (n = $('body').attr('data-asset-path')),
    void 0 !== typeof e && null !== e)
  ) {
