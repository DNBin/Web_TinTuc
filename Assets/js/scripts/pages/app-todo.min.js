      ...
      o.on('submit', function (t) {
        if ((t.preventDefault(), o.valid())) {
          ...
          var e = $('#task-assigned').val(),
            s = '',
            l = {
              'Phill Buffer': M + 'images/portrait/small/avatar-s-3.jpg',
              'Chandler Bing': M + 'images/portrait/small/avatar-s-1.jpg',
              'Ross Geller': M + 'images/portrait/small/avatar-s-4.jpg',
              'Monica Geller': M + 'images/portrait/small/avatar-s-6.jpg',
              'Joey Tribbiani': M + 'images/portrait/small/avatar-s-2.jpg',
              'Rachel Green': M + 'images/portrait/small/avatar-s-11.jpg',
            },
