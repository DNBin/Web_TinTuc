$(function () {
  'use strict'
  var t = $('.datatable-project'),
    e = $('.invoice-table'),
    a = 'app-invoice-preview.html',
    s = '../../../app-assets/'
  if (
    ('laravel' === $('body').attr('data-framework') &&
      ((s = $('body').attr('data-asset-path')),
      (a = s + 'app/invoice/preview')),
    t.length)
  )
    t.DataTable({
      ajax: s + 'data/projects-list.json',
      ordering: !1,
      columns: [
        { data: '' },
        { data: 'project_name' },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (t, e, a, o) {
            ...
            return (
              '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar me-1">' +
              i +
              '</div></div><div class="d-flex flex-column"><span class="text-truncate fw-bolder">' +
              n +
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (t) {
              return 'Details of ' + t.data().framework
            },
          }),
          type: 'column',
    ...
    e.DataTable({
      ...
      columnDefs: [
        { className: 'control', responsivePriority: 2, targets: 0 },
        {
          targets: 1,
          width: '46px',
          render: function (t, e, s, o) {
            var n = s.invoice_id
            return '<a class="fw-bolder" href="' + a + '"> #' + n + '</a>'
          },
        },
        {
          targets: 2,
          ...
          render: function (t, e, a, s) {
            ...
            return (
              ...
              feather.icons[r[o].icon].toSvg({ class: 'avatar-icon' }) +
              '</span></div></span>'
            )
          },
        },
        ...
        },
        {
          ...
          render: function (t, e, s, o) {
            return (
              ...
              '</a><a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top" title="Download">' +
