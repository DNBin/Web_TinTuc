            ...
            if ('' != r && 'unknown' != r)
              ...
              for (let n = 0; n < t.length; n++)
                t[n].innerHTML =
                  ...
                  r +
                  '-cc.png" height="24"/>'
            else for (let e = 0; e < t.length; e++) t[e].innerHTML = ''
          },
        })
      }),
    i.length &&
      new Cleave(i, { date: !0, delimiter: '/', datePattern: ['m', 'y'] }),
    s.length && new Cleave(s, { numeral: !0, numeralPositiveOnly: !0 }),
    d.length && new Cleave(d, { phone: !0, phoneRegionCode: 'US' }),
    o.length && new Cleave(o, { delimiter: '', numeral: !0 })
})
