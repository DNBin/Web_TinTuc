$(function () {
  'use strict'
  var t = Object.keys(feather.icons),
    e = $('#icons-search'),
    a = $('#icons-container'),
    c = 'rtl' === $('html').attr('data-textdirection')
  t.length &&
    t.map(function (t) {
      a.length &&
        a.append(
    ...
    e.length &&
      e.on('keyup', function () {
        ...
        $('.icon-card').filter(function () {
          var e = $(this)
          e.text().toLowerCase().indexOf(t) < !1
            ? e.css('display', 'none')
            : e.css('display', 'block')
        })
      }),
    $(document).on('click', '.icon-card', function () {
      var t,
        ...
        o = $(this),
        i = o.data('icon')
      a.find('.icon-card.active').removeClass('active'),
        o.addClass('active'),
        (t = i),
        ((e = document.createElement('input')).value = t),
        document.body.appendChild(e),
        e.select(),
        toastr.success(e.value.split("'")[1], 'Icon Name Copied! 📋', {
          closeButton: !0,
          tapToDismiss: !1,
          rtl: c,
        }),
