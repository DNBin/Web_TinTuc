...
$(function () {
  ...
  dragula([
    document.getElementById('multiple-list-group-a'),
  ...
  dragula(
    [
      document.getElementById('badge-list-1'),
      document.getElementById('badge-list-2'),
    ],
    {
      copy: true,
    }
  ...
  dragula(
    [
      document.getElementById('handle-list-1'),
