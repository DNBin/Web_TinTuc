$(function () {
  ...
  var t = $('#basic-alert'),
    ...
    o = $('#footer-alert'),
    i = $('#html-alert'),
    e = $('#position-top-start'),
    s = $('#position-top-end'),
    a = $('#position-bottom-start'),
    l = $('#position-bottom-end'),
    c = $('#bounce-in-animation'),
    r = $('#fade-in-animation'),
    u = $('#flip-x-animation'),
    m = $('#tada-animation'),
    f = $('#shake-animation'),
    ...
    w.length &&
      w.on('click', function () {
        Swal.fire({
          ...
          imageUrl: x + 'images/slider/04.jpg',
          imageWidth: 400,
          imageHeight: 200,
            ...
            Swal.showLoading(),
              (t = setInterval(() => {
                ...
                if (t) {
                  ...
                  n && (n.textContent = Swal.getTimerLeft())
                }
              }, 100))
          },
          willClose: () => {
      ...
      y.on('click', function () {
        ...
        !(async function () {
          ...
          for (i = 0; i < t.length; ) {
            ...
            e.value ? ((o[i] = e.value), i++) : 'cancel' === e.dismiss && i--
          }
