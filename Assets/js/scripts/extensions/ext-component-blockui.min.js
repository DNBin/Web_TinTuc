$(function () {
  ...
  var o = $('#section-block'),
    ...
    s = $('.btn-section-block-spinner'),
    r = $('.btn-section-block-custom'),
    n = $('.btn-section-block-multiple'),
    c = $('#card-block'),
    l = $('.btn-card-block'),
    a = $('.btn-card-block-overlay'),
    i = $('.btn-card-block-spinner'),
    b = $('.btn-card-block-custom'),
    d = $('.btn-card-block-multiple'),
    g = $('.btn-page-block'),
    u = $('.btn-page-block-overlay'),
    p = $('.btn-page-block-spinner'),
    f = $('.btn-page-block-custom'),
    m = $('.btn-page-block-multiple'),
    k = $('.form-block'),
    v = $('.btn-form-block'),
    y = $('.btn-form-block-overlay'),
    C = $('.btn-form-block-spinner'),
    S = $('.btn-form-block-custom'),
    h = $('.btn-form-block-multiple')
  e.length &&
    o.length &&
    e.on('click', function () {
      o.block({
